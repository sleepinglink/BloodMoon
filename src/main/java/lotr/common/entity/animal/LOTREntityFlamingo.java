...
public class LOTREntityFlamingo extends EntityAnimal {
    ...
    public void onLivingUpdate() {
        ...
        if(!(this.worldObj.isRemote || this.isChild() || this.isInLove() || this.getFishingTickCur() != 0 || this.rand.nextInt(600) != 0 || (block = this.worldObj.getBlock(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY), MathHelper.floor_double(this.posZ))) != Blocks.water)) {

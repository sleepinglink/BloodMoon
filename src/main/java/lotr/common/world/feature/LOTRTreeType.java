...
public enum LOTRTreeType {
    ...
    }),BOARISHNIK(new ITreeFactory() {

        @Override
        public WorldGenAbstractTree createTree(boolean flag, Random rand) {
            return new LOTRWorldGenSimpleTrees(flag, 4, 6, LOTRMod.wood10, 0, LOTRMod.leaves10, 0);
        }  
    }),JACARANDA(new ITreeFactory() {

        @Override
        public WorldGenAbstractTree createTree(boolean flag, Random rand) {
            return new LOTRWorldGenSimpleTrees(flag, 4, 6, LOTRMod.wood10, 1, LOTRMod.leaves10, 1);
        }  
    })

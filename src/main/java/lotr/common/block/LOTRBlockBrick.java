...
public class LOTRBlockBrick extends LOTRBlockBrickBase implements LOTRConnectedBlock {
    public LOTRBlockBrick() {
        this.setBrickNames("mordor", "gondor"  , "gondorMossy", "gondorCracked", "rohan",
        		"gondorCarved", "dwarven", "mordorCracked", "dwarvenSilver", "dwarvenGold", 
        		"dwarvenMithril", "galadhrim", "galadhrimMossy", "galadhrimCracked", "blueRock",
        		"nearHarad");
    }

...
public class LOTRCommonProxy implements IGuiHandler {
    ...
    public static final int GUI_ID_RED_MOUNTAINS=65;
    public static final int GUI_ID_WIND_MOUNTAINS=66;
    public static final int GUI_ID_KHAND=67;
    public static final int GUI_ID_NUMENOR=68;
    public static final int GUI_ID_DARK_WOOD=69;
    ...
    public Object getServerGuiElement(int ID, EntityPlayer entityplayer, World world, int i, int j, int k) {
        ...
        if(ID == 65) {
            return new LOTRContainerCraftingTable.RED_MOUNTAIN(entityplayer.inventory, world, i, j, k);
        } 
        if(ID == 66) {
            return new LOTRContainerCraftingTable.WIND_MOUNTAIN(entityplayer.inventory, world, i, j, k);
        }
        if(ID == 67) {
            return new LOTRContainerCraftingTable.KHAND(entityplayer.inventory, world, i, j, k);
        }
        if(ID == 68) {
            return new LOTRContainerCraftingTable.NUMENOR(entityplayer.inventory, world, i, j, k);
        }
        if(ID == 69) {
            return new LOTRContainerCraftingTable.DARK_WOOD(entityplayer.inventory, world, i, j, k);
        }
    ...
    public Object getClientGuiElement(int ID, EntityPlayer entityplayer, World world, int i, int j, int k) {
        ...
        if(ID == 65) {
            return new LOTRGuiCraftingTable.RED_MOUNTAIN(entityplayer.inventory, world, i, j, k);
        } 
        if(ID == 66) {
            return new LOTRGuiCraftingTable.WIND_MOUNTAIN(entityplayer.inventory, world, i, j, k);
        }
        if(ID == 67) {
            return new LOTRGuiCraftingTable.KHAND(entityplayer.inventory, world, i, j, k);
        }
        if(ID == 68) {
            return new LOTRGuiCraftingTable.NUMENOR(entityplayer.inventory, world, i, j, k);
        }
        if(ID == 69) {
            return new LOTRGuiCraftingTable.DARK_WOOD(entityplayer.inventory, world, i, j, k);
        }

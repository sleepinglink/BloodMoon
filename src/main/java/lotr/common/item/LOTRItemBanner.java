...
public class LOTRItemBanner extends Item {
    ...
    public static enum BannerType {
        ...
        RED_MOUNTAINS(41, "red_mountains", LOTRFaction.RED_MOUNTAINS),
        WIND_MOUNTAINS(42, "wind_mountains", LOTRFaction.WIND_MOUNTAINS),
    	KHAND(43, "khand", LOTRFaction.KHAND),
    	NUMENOR(44, "numenor", LOTRFaction.NUMENOR),
    	DARK_WOOD(45, "darkwood", LOTRFaction.DARK_WOOD);

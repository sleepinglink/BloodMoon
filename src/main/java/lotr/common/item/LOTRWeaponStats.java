...
public class LOTRWeaponStats {
    ...
    public static boolean isRangedWeapon(ItemStack itemstack) {
        if(itemstack != null) {
            Item item = itemstack.getItem();
            return item instanceof ItemBow || item instanceof LOTRItemSpear || item instanceof LOTRItemJavelin || item instanceof LOTRItemBlowgun || item instanceof LOTRItemThrowingAxe;
        }
        return false;
    }
    ...
    public static float getRangedSpeed(ItemStack itemstack) {
        ...
        if(itemstack != null) {
            ...
            if(item instanceof LOTRItemJavelin) {
                time = ((LOTRItemJavelin) item).getMaxDrawTime();
            }
    ...
    public static float getRangedDamageFactor(ItemStack itemstack, boolean launchSpeedOnly) {
        ...
        if(itemstack != null) {
            ...
            if(item instanceof LOTRItemCrossbow) {
                ...
                weaponFactor = ((LOTRItemJavelin) item).getRangedDamageMultiplier(itemstack, null, null);
            }

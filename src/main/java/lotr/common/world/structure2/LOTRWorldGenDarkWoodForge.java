...
public abstract class LOTRWorldGenDarkWoodForge extends LOTRWorldGenStructureBase2 {
    ...
    public LOTRWorldGenDarkWoodForge(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        if(!this.ruined) {
            this.placeChest(world, random, -1, 2, 4, this.chestBlock, 2, LOTRChestContents2.DARKWOOD_FORGE);

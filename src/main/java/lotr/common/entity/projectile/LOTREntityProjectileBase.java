    ...
    public void onUpdate() {
        ...
        if(this.inGround) {
            ...
            for(l = 0; l < list.size(); ++l) {
                ...
                if(!entity1.canBeCollidedWith() || entity1 == this.shootingEntity && this.ticksInAir < 5 || (movingobjectposition1 = (axisalignedbb1 = entity1.boundingBox.expand(f5 = 0.3f, f5, f5)).calculateIntercept(vec3d, vec3d1)) == null || !((d1 = vec3d.distanceTo(movingobjectposition1.hitVec)) < d) && d != 0.0) continue;
                entity = entity1;
                d = d1;
            }
            if(entity != null) {

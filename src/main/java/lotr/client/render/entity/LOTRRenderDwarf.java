...
public class LOTRRenderDwarf extends LOTRRenderBiped {
    ...
    public LOTRRenderDwarf() {
        ...
        redDwarfSkinsMale = LOTRRandomSkins.loadSkinsList("lotr:mob/dwarf/redMountains_male");
        redDwarfSkinsFemale = LOTRRandomSkins.loadSkinsList("lotr:mob/dwarf/redMountains_female");
        windDwarfSkinsMale = LOTRRandomSkins.loadSkinsList("lotr:mob/dwarf/windMountains_male");
        windDwarfSkinsFemale = LOTRRandomSkins.loadSkinsList("lotr:mob/dwarf/windMountains_female");
    }

...
public class LOTREntityRohanFarmhand extends LOTREntityRohanMan implements LOTRFarmhand {
    public Item seedsItem;

    public LOTREntityRohanFarmhand(World world) {
        super(world);

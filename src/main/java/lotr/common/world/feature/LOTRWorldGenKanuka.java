            ...
            for(int pass = 0; pass <= 1; ++pass) {
                ...
                while(deg < 360) {
                    ...
                    for(int l = 0; l < (length += this.trunkWidth); ++l) {
                        ...
                        if(!(block = world.getBlock(i1, j1, k1)).isReplaceable(world, i1, j1, k1) && !block.isWood(world, i1, j1, k1) && !block.isLeaves(world, i1, j1, k1)) break;
                        this.setBlockAndNotifyAdequately(world, i1, j1, k1, this.woodBlock, this.woodMeta | 0xC);
                    }
        ...
        for(int j1 = 0; j1 < leafHeight; ++j1) {
            ...
            for(int i1 = i - leafRange; i1 <= i + leafRange; ++i1) {
                for(int k1 = k - leafRange; k1 <= k + leafRange; ++k1) {
                    ...
                    if(dist > leafRange || !(block = world.getBlock(i1, j2, k1)).isReplaceable(world, i1, j2, k1) && !block.isLeaves(world, i1, j2, k1)) continue;

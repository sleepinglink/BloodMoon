...
public class LOTRWorldGenBerryBush extends WorldGenerator {
    ...
    public boolean generate(World world, Random random, int i, int j, int k) {
        ...
        LOTRBlockBerryBush.BushType bushType = LOTRBlockBerryBush.BushType.randomType(random);
        ...
        for(int l = 0; l < 12; ++l) {
            ...
            if(!below.canSustainPlant(world, i1, j1 - 1, k1, ForgeDirection.UP, (IPlantable) (Blocks.sapling)) || block.getMaterial().isLiquid() || !block.isReplaceable(world, i1, j1, k1)) continue;

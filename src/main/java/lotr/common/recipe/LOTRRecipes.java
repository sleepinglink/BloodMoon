...
public class LOTRRecipes {
	public static List<IRecipe> numenorRecipes = new ArrayList<IRecipe>();
	public static List<IRecipe> dark_woodRecipes = new ArrayList<IRecipe>();
	public static List<IRecipe> khandRecipes = new ArrayList<IRecipe>();
	public static List<IRecipe> red_mountainsRecipes = new ArrayList<IRecipe>();
	public static List<IRecipe> wind_mountainsRecipes = new ArrayList<IRecipe>();
    ...
    private static List[] commonElfRecipes = new List[] {elvenRecipes, woodElvenRecipes, highElvenRecipes, rivendellRecipes, dark_woodRecipes};
    private static List[] commonHighElfRecipes = new List[] {highElvenRecipes, rivendellRecipes};
    private static List[] commonDwarfRecipes = new List[] {dwarvenRecipes, blueMountainsRecipes, red_mountainsRecipes, wind_mountainsRecipes};
    private static List[] commonDunedainRecipes = new List[] {gondorianRecipes, rangerRecipes, dolAmrothRecipes};
    private static List[] commonNumenoreanRecipes = new List[] {gondorianRecipes, dolAmrothRecipes, umbarRecipes, numenorRecipes};
    private static List[] commonNearHaradRecipes = new List[] {nearHaradRecipes, umbarRecipes, gulfRecipes, khandRecipes};
    ...
    public static void createAllRecipes() {
        ...
        LOTRRecipes.createNumenorRecipes();
        LOTRRecipes.createDark_WoodRecipes();
        LOTRRecipes.createKhandRecipes();
        LOTRRecipes.createRedMountainsRecipes();
        LOTRRecipes.createWindMountainsRecipes();
    ...
    private static void createSmeltingRecipes() {
        ...
        GameRegistry.addSmelting(LOTRMod.horsemeatRaw, new ItemStack(LOTRMod.horsemeatCooked), 0.35f);
    ...
    private static void createCommonHighElfRecipes() {
        ...
        LOTRRecipes.addRecipeTo(commonHighElfRecipes, new ShapedOreRecipe(new ItemStack(LOTRMod.highElfWoodBars, 16), "XXX", "XXX", Character.valueOf('X'), "plankWood"));
    ...
    private static void createMorgulRecipes() {
        ...
        morgulRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.pikeBlackUruk), "  X", " YX", "Y  ", Character.valueOf('X'), LOTRMod.blackUrukSteel, Character.valueOf('Y'), "stickWood"));
    ...
    private static void createElvenRecipes() {
        ...
        elvenRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.galadhrimWoodBars, 16), "XXX", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.planks, 1, 1)));
    ...
    public static void createRedMountainsRecipes() {
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.red_dwarven_table), new Object[]{"XX", "YY", 'X', "plankWood", 'Y', new ItemStack(LOTRMod.brick, 1, 6)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.shovel_red_dwarven), new Object[]{"X", "Y", "Y", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.pickaxe_red_dwarven), new Object[]{"XXX", " Y ", " Y ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.axe_red_dwarven), new Object[]{"XX", "XY", " Y", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.sword_red_dwarven), new Object[]{"X", "X", "Y", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.hoe_red_dwarven), new Object[]{"XX", " Y", " Y", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dagger_red_dwarven), new Object[]{"X", "Y", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.battleaxe_red_dwarven), new Object[]{"XXX", "XYX", " Y ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.hammer_red_dwarven), new Object[]{"XYX", "XYX", " Y ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.helmet_red_dwarven), new Object[]{"XXX", "X X", 'X', LOTRMod.dwarfSteel}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.body_red_dwarven), new Object[]{"X X", "XXX", "XXX", 'X', LOTRMod.dwarfSteel}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.legs_red_dwarven), new Object[]{"XXX", "X X", "X X", 'X', LOTRMod.dwarfSteel}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.boots_red_dwarven), new Object[]{"X X", "X X", 'X', LOTRMod.dwarfSteel}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.throwing_axe_red_dwarven), new Object[]{" X ", " YX", "Y  ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.chandelier, 0, 8), new Object[]{" X ", "YZY", 'X', "stickWood", 'Y', Blocks.torch, 'Z', LOTRMod.dwarfSteel}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.mattock_red_dwarven), new Object[]{"XXX", "XY ", " Y ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.banner, 1, LOTRItemBanner.BannerType.RED_MOUNTAINS.bannerID), new Object[]{"X", "Y", "Z", 'X', Blocks.wool, 'Y', "stickWood", 'Z', "plankWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.spear_red_dwarven), new Object[]{"  X", " Y ", "Y  ", 'X',LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.red_dwarf_bars, 16), new Object[]{"XXX", "XXX", 'X', LOTRMod.dwarfSteel}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.boar_armor_red_dwarven), new Object[]{"X  ", "XYX", "XXX", 'X', LOTRMod.dwarfSteel, 'Y', Items.leather}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.pike_red_dwarven), new Object[]{"  X", " YX", "Y  ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.gateDwarven, 4), new Object[]{"ZYZ", "YXY", "ZYZ", 'X', LOTRMod.gateGear, 'Y', new ItemStack(LOTRMod.brick, 1, 6), 'Z', LOTRMod.dwarfSteel}));     
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 4, 6), new Object[]{"XX", "XX", 'X', Blocks.stone}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsDwarvenBrick, 4), new Object[]{"X  ", "XX ", "XXX", 'X', new ItemStack(LOTRMod.brick, 1, 6)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle, 6, 7), new Object[]{"XXX", 'X', new ItemStack(LOTRMod.brick, 1, 6)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall, 6, 7), new Object[]{"XXX", "XXX", 'X', new ItemStack(LOTRMod.brick, 1, 6)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.pillar, 3, 0), new Object[]{"X", "X", "X", 'X', Blocks.stone}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dwarvenForge), new Object[]{"XXX", "X X", "XXX", 'X', new ItemStack(LOTRMod.brick, 1, 6)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle2, 6, 0), new Object[]{"XXX", 'X', new ItemStack(LOTRMod.pillar, 1, 0)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dwarvenDoor), new Object[]{"XX", "XX", "XX", 'X', Blocks.stone}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dwarvenDoorIthildin), new Object[]{"XX", "XY", "XX", 'X', Blocks.stone, 'Y', new ItemStack(LOTRMod.ithildin, 1, 0)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dwarvenBedItem), new Object[]{"XXX", "YYY", 'X', Blocks.wool, 'Y', "plankWood"}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 1, 8), new Object[]{" X ", "XYX", " X ", 'X', "nuggetSilver", 'Y', new ItemStack(LOTRMod.brick, 1, 6)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 1, 9), new Object[]{" X ", "XYX", " X ", 'X', "nuggetGold", 'Y', new ItemStack(LOTRMod.brick, 1, 6)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 1, 10), new Object[]{" X ", "XYX", " X ", 'X', LOTRMod.mithrilNugget, 'Y', new ItemStack(LOTRMod.brick, 1, 6)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick2, 1, 12), new Object[]{"XX", "XX", 'X', new ItemStack(LOTRMod.brick, 1, 6)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick3, 1, 12), new Object[]{" X ", "XYX", " X ", 'X', Items.glowstone_dust, 'Y', new ItemStack(LOTRMod.brick, 1, 6)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsDwarvenBrickCracked, 4), new Object[]{"X  ", "XX ", "XXX", 'X', new ItemStack(LOTRMod.brick4, 1, 5)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle7, 6, 6), new Object[]{"XXX", 'X', new ItemStack(LOTRMod.brick4, 1, 5)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall4, 6, 5), new Object[]{"XXX", "XXX", 'X', new ItemStack(LOTRMod.brick4, 1, 5)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle7, 6, 7), new Object[]{"XXX", 'X', new ItemStack(LOTRMod.pillar2, 1, 0)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick4, 4, 14), new Object[]{"XX", "XX", 'X', LOTRMod.obsidianShard}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsDwarvenBrickObsidian, 4), new Object[]{"X  ", "XX ", "XXX", 'X', new ItemStack(LOTRMod.brick4, 1, 14)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle8, 6, 6), new Object[]{"XXX", 'X', new ItemStack(LOTRMod.brick4, 1, 14)}));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall4, 6, 6), new Object[]{"XXX", "XXX", 'X', new ItemStack(LOTRMod.brick4, 1, 14)}));
        red_mountainsRecipes.add(new LOTRRecipePoisonWeapon(LOTRMod.chisel, LOTRMod.chiselIthildin, new ItemStack(LOTRMod.ithildin, 1, 0)));
        red_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.ironCrossbow), new Object[]{"XXY", "ZYX", "YZX", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood", 'Z', Items.string}));
     }
    
    public static void createKhandRecipes() {
    	  LOTRRecipes.addRecipeTo(commonNearHaradRecipes, new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 4, 15), "XX", "XX", Character.valueOf('X'), new ItemStack(Blocks.sandstone, 1, 0)));
          LOTRRecipes.addRecipeTo(commonNearHaradRecipes, new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle4, 6, 0), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 15)));
          LOTRRecipes.addRecipeTo(commonNearHaradRecipes, new ShapedOreRecipe(new ItemStack(LOTRMod.stairsNearHaradBrick, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 15)));
          LOTRRecipes.addRecipeTo(commonNearHaradRecipes, new ShapedOreRecipe(new ItemStack(LOTRMod.wall, 6, 15), "XXX", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 15)));
    ...
    public static void createDark_WoodRecipes() {
 
    }
    public static void createNumenorRecipes() {
    	numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.numenor_table), "XX", "YY", Character.valueOf('X'), "plankWood", Character.valueOf('Y'), new ItemStack(LOTRMod.rock, 1, 1)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.beacon), "XXX", "XXX", "YYY", Character.valueOf('X'), "logWood", Character.valueOf('Y'), Blocks.cobblestone));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle11, 6, 3), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.rock, 1, 1)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.smoothStone, 2, 1), "X", "X", Character.valueOf('X'), new ItemStack(LOTRMod.rock, 1, 1)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle, 6, 2), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.smoothStone, 1, 1)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 4, 1), "XX", "XX", Character.valueOf('X'), new ItemStack(LOTRMod.rock, 1, 1)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle, 6, 3), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 1)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsGondorBrick, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 1)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall, 6, 2), "XXX", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.rock, 1, 1)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall, 6, 3), "XXX", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 1)));
        numenorRecipes.add(new ShapelessOreRecipe(new ItemStack(LOTRMod.brick, 1, 2), new ItemStack(LOTRMod.brick, 1, 1), "vine"));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle, 6, 4), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 2)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsGondorBrickMossy, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 2)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall, 6, 4), "XXX", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 2)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle, 6, 5), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 3)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsGondorBrickCracked, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 3)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall, 6, 5), "XXX", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 3)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 1, 5), "XX", "XX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 1)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.helmetNumenor), "XXX", "X X", Character.valueOf('X'), "ingotIron"));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.bodyNumenor), "X X", "XXX", "XXX", Character.valueOf('X'), "ingotIron"));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.legsNumenor), "XXX", "X X", "X X", Character.valueOf('X'), "ingotIron"));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.bootsNumenor), "X X", "X X", Character.valueOf('X'), "ingotIron"));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.swordNumenor), "X", "X", "Y", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), "stickWood"));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.spearNumenor), "  X", " Y ", "Y  ", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), "stickWood"));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.daggerNumenor), "X", "Y", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), "stickWood"));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.hammerNumenor), "XYX", "XYX", " Y ", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), "stickWood"));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.numenorBow), " XY", "X Y", " XY", Character.valueOf('X'), "stickWood", Character.valueOf('Y'), Items.string));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.banner, 1, LOTRItemBanner.BannerType.NUMENOR.bannerID), "X", "Y", "Z", Character.valueOf('X'), Blocks.wool, Character.valueOf('Y'), "stickWood", Character.valueOf('Z'), "plankWood"));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.horseArmorNumenor), "X  ", "XYX", "XXX", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), Items.leather));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick5, 4, 8), "XY", "YX", Character.valueOf('X'), new ItemStack(LOTRMod.rock, 1, 1), Character.valueOf('Y'), Blocks.cobblestone));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle11, 6, 0), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick5, 1, 8)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsGondorBrickRustic, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick5, 1, 8)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall4, 6, 7), "XXX", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick5, 1, 8)));
        numenorRecipes.add(new ShapelessOreRecipe(new ItemStack(LOTRMod.brick5, 1, 9), new ItemStack(LOTRMod.brick5, 1, 8), "vine"));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle11, 6, 1), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick5, 1, 9)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsGondorBrickRusticMossy, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick5, 1, 9)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall4, 6, 8), "XXX", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick5, 1, 9)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle11, 6, 2), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick5, 1, 10)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsGondorBrickRusticCracked, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick5, 1, 10)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall4, 6, 9), "XXX", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick5, 1, 10)));
        numenorRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick4, 1, 6), "XX", "XX", Character.valueOf('X'), new ItemStack(LOTRMod.brick2, 1, 11)));
    }

    public static void createWindMountainsRecipes() {
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wind_dwarven_table), new Object[]{"XX", "YY", 'X', "plankWood", 'Y', new ItemStack(LOTRMod.brick, 1, 6)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.shovel_wind_dwarven), new Object[]{"X", "Y", "Y", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.pickaxe_wind_dwarven), new Object[]{"XXX", " Y ", " Y ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.axe_wind_dwarven), new Object[]{"XX", "XY", " Y", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.sword_wind_dwarven), new Object[]{"X", "X", "Y", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.hoe_wind_dwarven), new Object[]{"XX", " Y", " Y", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dagger_wind_dwarven), new Object[]{"X", "Y", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.battleaxe_wind_dwarven), new Object[]{"XXX", "XYX", " Y ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.hammer_wind_dwarven), new Object[]{"XYX", "XYX", " Y ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.helmet_wind_dwarven), new Object[]{"XXX", "X X", 'X', LOTRMod.dwarfSteel}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.body_wind_dwarven), new Object[]{"X X", "XXX", "XXX", 'X', LOTRMod.dwarfSteel}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.legs_wind_dwarven), new Object[]{"XXX", "X X", "X X", 'X', LOTRMod.dwarfSteel}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.boots_wind_dwarven), new Object[]{"X X", "X X", 'X', LOTRMod.dwarfSteel}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.throwing_axe_wind_dwarven), new Object[]{" X ", " YX", "Y  ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.chandelier, 1, 8), new Object[]{" X ", "YZY", 'X', "stickWood", 'Y', Blocks.torch, 'Z', LOTRMod.dwarfSteel}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.mattock_wind_dwarven), new Object[]{"XXX", "XY ", " Y ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.banner, 1, LOTRItemBanner.BannerType.WIND_MOUNTAINS.bannerID), new Object[]{"X", "Y", "Z", 'X', Blocks.wool, 'Y', "stickWood", 'Z', "plankWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.spear_wind_dwarven), new Object[]{"  X", " Y ", "Y  ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wind_dwarf_bars, 16), new Object[]{"XXX", "XXX", 'X', LOTRMod.dwarfSteel}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.boar_armor_wind_dwarven), new Object[]{"X  ", "XYX", "XXX", 'X', LOTRMod.dwarfSteel, 'Y', Items.leather}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.pike_wind_dwarven), new Object[]{"  X", " YX", "Y  ", 'X', LOTRMod.dwarfSteel, 'Y', "stickWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.gateDwarven, 4), new Object[]{"ZYZ", "YXY", "ZYZ", 'X', LOTRMod.gateGear, 'Y', new ItemStack(LOTRMod.brick, 1, 6), 'Z', LOTRMod.dwarfSteel}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 4, 6), new Object[]{"XX", "XX", 'X', Blocks.stone}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsDwarvenBrick, 4), new Object[]{"X  ", "XX ", "XXX", 'X', new ItemStack(LOTRMod.brick, 1, 6)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle, 6, 7), new Object[]{"XXX", 'X', new ItemStack(LOTRMod.brick, 1, 6)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall, 6, 7), new Object[]{"XXX", "XXX", 'X', new ItemStack(LOTRMod.brick, 1, 6)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.pillar, 3, 0), new Object[]{"X", "X", "X", 'X', Blocks.stone}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dwarvenForge), new Object[]{"XXX", "X X", "XXX", 'X', new ItemStack(LOTRMod.brick, 1, 6)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle2, 6, 0), new Object[]{"XXX", 'X', new ItemStack(LOTRMod.pillar, 1, 0)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dwarvenDoor), new Object[]{"XX", "XX", "XX", 'X', Blocks.stone}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dwarvenDoorIthildin), new Object[]{"XX", "XY", "XX", 'X', Blocks.stone, 'Y', new ItemStack(LOTRMod.ithildin, 1, 0)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dwarvenBedItem), new Object[]{"XXX", "YYY", 'X', Blocks.wool, 'Y', "plankWood"}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 1, 8), new Object[]{" X ", "XYX", " X ", 'X', "nuggetSilver", 'Y', new ItemStack(LOTRMod.brick, 1, 6)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 1, 9), new Object[]{" X ", "XYX", " X ", 'X', "nuggetGold", 'Y', new ItemStack(LOTRMod.brick, 1, 6)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 1, 10), new Object[]{" X ", "XYX", " X ", 'X', LOTRMod.mithrilNugget, 'Y', new ItemStack(LOTRMod.brick, 1, 6)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick2, 1, 12), new Object[]{"XX", "XX", 'X', new ItemStack(LOTRMod.brick, 1, 6)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick3, 1, 12), new Object[]{" X ", "XYX", " X ", 'X', Items.glowstone_dust, 'Y', new ItemStack(LOTRMod.brick, 1, 6)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsDwarvenBrickCracked, 4), new Object[]{"X  ", "XX ", "XXX", 'X', new ItemStack(LOTRMod.brick4, 1, 5)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle7, 6, 6), new Object[]{"XXX", 'X', new ItemStack(LOTRMod.brick4, 1, 5)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall4, 6, 5), new Object[]{"XXX", "XXX", 'X', new ItemStack(LOTRMod.brick4, 1, 5)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle7, 6, 7), new Object[]{"XXX", 'X', new ItemStack(LOTRMod.pillar2, 1, 0)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick4, 4, 14), new Object[]{"XX", "XX", 'X', LOTRMod.obsidianShard}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsDwarvenBrickObsidian, 4), new Object[]{"X  ", "XX ", "XXX", 'X', new ItemStack(LOTRMod.brick4, 1, 14)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle8, 6, 6), new Object[]{"XXX", 'X', new ItemStack(LOTRMod.brick4, 1, 14)}));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall4, 6, 6), new Object[]{"XXX", "XXX", 'X', new ItemStack(LOTRMod.brick4, 1, 14)}));
        wind_mountainsRecipes.add(new LOTRRecipePoisonWeapon(LOTRMod.chisel, LOTRMod.chiselIthildin, new ItemStack(LOTRMod.ithildin, 1, 0)));
        wind_mountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wind_dwarvenCrossbow), "XXY", "ZYX", "YZX", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood", Character.valueOf('Z'), Items.string));
     }
    ...
    private static void createWoodElvenRecipes() {
        ...
        woodElvenRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.woodElfWoodBars, 16), "XXX", "XXX", Character.valueOf('X'), "plankWood"));
    ...
    private static void createBlueMountainsRecipes() {
        ...
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.shovelBlueDwarven), "X", "Y", "Y", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.pickaxeBlueDwarven), "XXX", " Y ", " Y ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.axeBlueDwarven), "XX", "XY", " Y", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.swordBlueDwarven), "X", "X", "Y", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.hoeBlueDwarven), "XX", " Y", " Y", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.daggerBlueDwarven), "X", "Y", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.battleaxeBlueDwarven), "XXX", "XYX", " Y ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.hammerBlueDwarven), "XYX", "XYX", " Y ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.helmetBlueDwarven), "XXX", "X X", Character.valueOf('X'), LOTRMod.dwarfSteel));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.bodyBlueDwarven), "X X", "XXX", "XXX", Character.valueOf('X'), LOTRMod.dwarfSteel));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.legsBlueDwarven), "XXX", "X X", "X X", Character.valueOf('X'), LOTRMod.dwarfSteel));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.bootsBlueDwarven), "X X", "X X", Character.valueOf('X'), LOTRMod.dwarfSteel));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.throwingAxeBlueDwarven), " X ", " YX", "Y  ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.chandelier, 2, 11), " X ", "YZY", Character.valueOf('X'), "stickWood", Character.valueOf('Y'), Blocks.torch, Character.valueOf('Z'), LOTRMod.dwarfSteel));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.mattockBlueDwarven), "XXX", "XY ", " Y ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
        ...
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.spearBlueDwarven), "  X", " Y ", "Y  ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.blueDwarfBars, 16), "XXX", "XXX", Character.valueOf('X'), LOTRMod.dwarfSteel));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.boarArmorBlueDwarven), "X  ", "XYX", "XXX", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), Items.leather));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.pikeBlueDwarven), "  X", " YX", "Y  ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
        blueMountainsRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.gateDwarven, 4), "ZYZ", "YXY", "ZYZ", Character.valueOf('X'), LOTRMod.gateGear, Character.valueOf('Y'), new ItemStack(LOTRMod.brick, 1, 6), Character.valueOf('Z'), LOTRMod.dwarfSteel));
    }
    ...
    private static void createHobbitRecipes() {
        ...
        hobbitRecipes.add(new ShapedOreRecipe(new ItemStack(LOTRMod.hobbitOven), "XXX", "X X", "XXX", Character.valueOf('X'), Blocks.brick_block));

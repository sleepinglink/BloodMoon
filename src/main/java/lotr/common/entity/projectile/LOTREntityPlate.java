...
public class LOTREntityPlate extends EntityThrowable implements IEntityAdditionalSpawnData {
    ...
    private boolean breakGlass(int i, int j, int k) {
        ...
        if(block.getMaterial() == Material.glass && !(bannerProtection = LOTRBannerProtection.isProtectedByBanner(this.worldObj, i, j, k, LOTRBannerProtection.forThrown(this), true))) {

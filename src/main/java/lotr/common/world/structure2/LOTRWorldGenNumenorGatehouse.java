...
public class LOTRWorldGenNumenorGatehouse extends LOTRWorldGenNumenorStructure {
    private String[] signText = LOTRNames.getGondorVillageName(new Random());

    public LOTRWorldGenNumenorGatehouse(boolean flag) {
        super(flag);
    }

    public LOTRWorldGenNumenorGatehouse setSignText(String[] s) {
        this.signText = s;
        return this;
    }

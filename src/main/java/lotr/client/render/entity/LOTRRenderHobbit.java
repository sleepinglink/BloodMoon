...
public class LOTRRenderHobbit extends LOTRRenderBiped {
    ...
    private ModelBiped standardRenderPassModel = new LOTRModelHobbit(0.5f, 64, 64);
    ...
    static {
        apron = new ResourceLocation("lotr:mob/hobbit/bartender_apron.png");

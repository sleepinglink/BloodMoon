...
public abstract class LOTRWorldGenNumenorStructure extends LOTRWorldGenStructureBase2 {
    public GondorFiefdom strFief = GondorFiefdom.NUMENOR;
    ...
    public LOTRWorldGenNumenorStructure(boolean flag) {
        super(flag);
    }
    ...
    protected void setupRandomBlocks(Random random) {
        ...
        this.tableBlock = LOTRMod.numenor_table;
        ...
        this.plateBlock = this.strFief == GondorFiefdom.LOSSARNACH || this.strFief == GondorFiefdom.NUMENOR || this.strFief == GondorFiefdom.LAMEDON || this.strFief == GondorFiefdom.BLACKROOT_VALE ? (random.nextBoolean() ? LOTRMod.woodPlateBlock : LOTRMod.ceramicPlateBlock) : LOTRMod.ceramicPlateBlock;
        if(random.nextBoolean()) {
        ...
        if(this.strFief == GondorFiefdom.NUMENOR) {
            this.bannerType = LOTRItemBanner.BannerType.NUMENOR;
        }
        ...
        this.bannerType2 = this.strFief == GondorFiefdom.NUMENOR ? LOTRItemBanner.BannerType.NUMENOR : LOTRItemBanner.BannerType.NUMENOR;
        this.chestContents = LOTRChestContents2.NUMENOR_HOUSE;
    }

    protected ItemStack getGondorFramedItem(Random random) {
        ItemStack[] items = new ItemStack[] {new ItemStack(LOTRMod.helmetNumenor),
        		new ItemStack(LOTRMod.bodyNumenor), new ItemStack(LOTRMod.daggerNumenor),
        		new ItemStack(LOTRMod.spearNumenor), new ItemStack(LOTRMod.numenorBow),
        		new ItemStack(Items.arrow), new ItemStack(Items.iron_sword),
        		new ItemStack(Items.iron_axe), new ItemStack(LOTRMod.daggerIron),
        		new ItemStack(LOTRMod.pikeIron), new ItemStack(LOTRMod.ironCrossbow),
        		new ItemStack(LOTRMod.goldRing), new ItemStack(LOTRMod.silverRing)};
        return items[random.nextInt(items.length)].copy();
    }

    public static enum GondorFiefdom {
        GONDOR, NUMENOR, LOSSARNACH, LEBENNIN, PELARGIR, PINNATH_GELIN, BLACKROOT_VALE, LAMEDON, DOL_AMROTH;
        ...
        public LOTREntityGondorMan createCaptain(World world) {
            ...
            if(this == NUMENOR) {
                return new LOTREntityNumenorCommander(world);
            }
            if(this == LOSSARNACH) {
        ...
        public Class[] getSoldierClasses() {
            ...
            if(this == NUMENOR) {
                return new Class[] {LOTREntityNumenorSoldier.class, LOTREntityNumenorArcher.class};
            }
            if(this == LOSSARNACH) {
        ...
        public Class[] getLevyClasses() {
            ...
            if(this == NUMENOR) {
                return new Class[] {LOTREntityNumenorLevyman.class, LOTREntityNumenorSoldier.class};
            }
            if(this == LOSSARNACH) {
        ...
        protected ItemStack[] getFiefdomArmor() {
            ...
            if(this == NUMENOR) {
                return new ItemStack[] {new ItemStack(LOTRMod.helmetNumenor), new ItemStack(LOTRMod.bodyNumenor), new ItemStack(LOTRMod.legsNumenor), new ItemStack(LOTRMod.bootsNumenor)};
            }
            if(this == LOSSARNACH) {

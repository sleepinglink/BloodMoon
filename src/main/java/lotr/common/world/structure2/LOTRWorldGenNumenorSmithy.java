...
import lotr.common.entity.npc.LOTREntityNumenorSmith;
import lotr.common.world.structure.LOTRChestContents;
import lotr.common.world.structure.LOTRChestContents2;
import net.minecraft.init.Blocks;
import net.minecraft.world.World;

public class LOTRWorldGenNumenorSmithy extends LOTRWorldGenNumenorStructure {
    public LOTRWorldGenNumenorSmithy(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        this.placeChest(world, random, 3, 1, 8, Blocks.chest, 5, LOTRChestContents2.NUMENOR_SMITHY);
        this.placeChest(world, random, 3, 1, 9, Blocks.chest, 5, LOTRChestContents2.NUMENOR_SMITHY);
        ...
        LOTREntityNumenorSmith blacksmith = new LOTREntityNumenorSmith(world);

    ...
    public void processCommand(ICommandSender sender, String[] args) {
        if(args.length == 1) {
            if(args[0].equals("on")) {
                ...
                CommandBase.func_152373_a(sender, this, "commands.lotr.strTimelapse.on", new Object[0]);
                CommandBase.func_152373_a(sender, this, "commands.lotr.strTimelapse.warn", new Object[0]);
                return;
            }
            if(args[0].equals("off")) {
                LOTRConfig.setStructureTimelapse(false);
                CommandBase.func_152373_a(sender, this, "commands.lotr.strTimelapse.off", new Object[0]);
                return;
            }

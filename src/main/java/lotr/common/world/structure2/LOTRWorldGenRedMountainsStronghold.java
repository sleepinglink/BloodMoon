...
import lotr.common.entity.npc.LOTREntityRedDwarfAxeThrower;
import lotr.common.entity.npc.LOTREntityRedDwarfCommander;
import lotr.common.entity.npc.LOTREntityRedDwarfWarrior;
...
public class LOTRWorldGenRedMountainsStronghold extends LOTRWorldGenStructureBase{
	 public LOTRWorldGenRedMountainsStronghold(boolean flag) {
	      super(flag);
	   }
	    ...
	    public boolean generate(World world, Random random, int i, int j, int k) {
	        ...
	        for(k1 = k - 5; k1 <= k + 5; ++k1) {
	            for(i12 = i - 5; i12 <= i + 5; ++i12) {
	                this.setBlockAndNotifyAdequately(world, i12, j + 4, k1, LOTRMod.slabDouble3, 5);
	                this.setBlockAndNotifyAdequately(world, i12, j + 8, k1, LOTRMod.slabDouble3, 5);
	                ...
	                this.setBlockAndNotifyAdequately(world, i12, j + 9, k1, LOTRMod.wall2, 3);
	            }
	        }
	        ...
	        respawner.setSpawnClasses(LOTREntityRedDwarfWarrior.class, LOTREntityRedDwarfAxeThrower.class);
	    ...
	    private void generateFacingSouth(World world, Random random, int i, int j, int k) {
	        ...
	        for(i12 = i - 6; i12 <= i + 6; ++i12) {
	            ...
	            for(j12 = j; !LOTRMod.isOpaque(world, i12, j12, k - 7) && j12 >= 0; --j12) {
	                this.setBlockAndNotifyAdequately(world, i12, j12, k - 7, LOTRMod.pillar, 4);
	        ...
	        this.placeWallBanner(world, i, j + 6, k - 6, 2, LOTRItemBanner.BannerType.RED_MOUNTAINS);
	        for(j1 = j + 1; j1 <= j + 3; ++j1) {
	            for(k1 = k - 4; k1 <= k - 1; ++k1) {
	                for(i1 = i - 5; i1 <= i - 1; ++i1) {
	                    this.setBlockAndNotifyAdequately(world, i1, j1, k1, LOTRMod.brick2, 2);
	                }
	            ...
	            for(k1 = k - 2; k1 <= k + 5; ++k1) {
	                this.setBlockAndNotifyAdequately(world, i - 1, j1, k1, LOTRMod.brick2, 2);
	                this.setBlockAndNotifyAdequately(world, i + 1, j1, k1, LOTRMod.brick2, 2);
	            }
	        }
	        ...
	        for(i12 = i - 5; i12 <= i + 2; i12 += 7) {
	            ...
	            LOTRChestContents.fillChest(world, random, i12 + 2, j + 1, k, LOTRChestContents.RED_MOUNTAINS_STRONGHOLD);
	        ...
	        for(i13 = i - 5; i13 <= i + 5; i13 += 10) {
	            ...
	            this.setBlockAndNotifyAdequately(world, i13, j + 5, k + 2, Blocks.planks, 1);
	            this.setBlockAndNotifyAdequately(world, i13, j + 6, k + 2, Blocks.wooden_slab, 1);
	            this.setBlockAndNotifyAdequately(world, i13, j + 5, k, LOTRMod.red_dwarven_table, 0);
	    ...
	    private void generateFacingWest(World world, Random random, int i, int j, int k) {
	        ...
	        for(k13 = k - 6; k13 <= k + 6; ++k13) {
	            ...
	            for(j12 = j; !LOTRMod.isOpaque(world, i + 7, j12, k13) && j12 >= 0; --j12) {
	                this.setBlockAndNotifyAdequately(world, i + 7, j12, k13, LOTRMod.pillar, 4);
	        ...
	        this.placeWallBanner(world, i + 6, j + 6, k, 3, LOTRItemBanner.BannerType.RED_MOUNTAINS);
	        for(j1 = j + 1; j1 <= j + 3; ++j1) {
	            for(i1 = i + 4; i1 >= i + 1; --i1) {
	                for(k12 = k - 5; k12 <= k - 1; ++k12) {
	                    this.setBlockAndNotifyAdequately(world, i1, j1, k12, LOTRMod.brick2, 2);
	                }
	            ...
	            for(i1 = i + 2; i1 >= i - 5; --i1) {
	                this.setBlockAndNotifyAdequately(world, i1, j1, k - 1, LOTRMod.brick2, 2);
	                this.setBlockAndNotifyAdequately(world, i1, j1, k + 1, LOTRMod.brick2, 2);
	            }
	        }
	        ...
	        for(k13 = k - 5; k13 <= k + 2; k13 += 7) {
	            ...
	            LOTRChestContents.fillChest(world, random, i, j + 1, k13 + 2, LOTRChestContents.RED_MOUNTAINS_STRONGHOLD);
	        ...
	        for(k1 = k - 5; k1 <= k + 5; k1 += 10) {
	            ...
	            this.setBlockAndNotifyAdequately(world, i + 2, j + 5, k1, Blocks.planks, 1);
	            this.setBlockAndNotifyAdequately(world, i + 2, j + 6, k1, Blocks.wooden_slab, 1);
	            this.setBlockAndNotifyAdequately(world, i, j + 5, k1, LOTRMod.red_dwarven_table, 0);
	    ...
	    private void generateFacingNorth(World world, Random random, int i, int j, int k) {
	        ...
	        this.setBlockAndNotifyAdequately(world, i + 1, j + 3, k + 7, LOTRMod.stairsDwarvenBrick, 1);
	        this.setBlockAndNotifyAdequately(world, i, j + 4, k + 7, LOTRMod.slabSingle, 7);
	        this.placeWallBanner(world, i, j + 6, k + 6, 0, LOTRItemBanner.BannerType.RED_MOUNTAINS);
	        for(j1 = j + 1; j1 <= j + 3; ++j1) {
	            for(k1 = k + 4; k1 >= k + 1; --k1) {
	                for(i1 = i - 5; i1 <= i - 1; ++i1) {
	                    this.setBlockAndNotifyAdequately(world, i1, j1, k1, LOTRMod.brick2, 2);
	    ...
	    private void generateFacingEast(World world, Random random, int i, int j, int k) {
	        ...
	        this.setBlockAndNotifyAdequately(world, i - 7, j + 3, k + 1, LOTRMod.stairsDwarvenBrick, 3);
	        this.setBlockAndNotifyAdequately(world, i - 7, j + 4, k, LOTRMod.slabSingle, 7);
	        this.placeWallBanner(world, i - 6, j + 6, k, 1, LOTRItemBanner.BannerType.RED_MOUNTAINS);
	        for(j1 = j + 1; j1 <= j + 3; ++j1) {
	            for(i1 = i - 4; i1 <= i - 1; ++i1) {
	                for(k12 = k - 5; k12 <= k - 1; ++k12) {
	                    this.setBlockAndNotifyAdequately(world, i1, j1, k12, LOTRMod.brick2, 2);
	    ...
	    private void spawnDwarfCommander(World world, int i, int j, int k) {
	        LOTREntityRedDwarfCommander dwarf = new LOTREntityRedDwarfCommander(world);
	    ...
	    private void spawnDwarf(World world, int i, int j, int k) {
	        LOTREntityRedDwarfWarrior dwarf = world.rand.nextInt(3) == 0 ? new LOTREntityRedDwarfAxeThrower(world) : new LOTREntityRedDwarfWarrior(world);
	        dwarf.setLocationAndAngles(i + 0.5, j, k + 0.5, 0.0f, 0.0f);
	        ((LOTREntityRedDwarf) dwarf).onSpawnWithEgg(null);

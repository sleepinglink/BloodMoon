...
public class LOTRBiomeGenAdornland extends LOTRBiome {
    ...
    public LOTRBiomeGenAdornland(int i, boolean major) {
        ...
        arrspawnListContainer2[0] = LOTRBiomeSpawnList.entry(LOTRSpawnList.URUK_HAI, 3);
        arrspawnListContainer2[1] = LOTRBiomeSpawnList.entry(LOTRSpawnList.URUK_WARGS, 2);

...
public enum LOTRShields {
	ALIGNMENT_NUMENOR(LOTRFaction.NUMENOR),
	ALIGNMENT_KHAND(LOTRFaction.KHAND),
	ALIGNMENT_DARK_WOOD(LOTRFaction.DARK_WOOD),
	ALIGNMENT_WIND_MOUNTAINS(LOTRFaction.WIND_MOUNTAINS),
    ...
    ALIGNMENT_RHUN(LOTRFaction.RHUN),
    ...
    ALIGNMENT_MOREDAIN(LOTRFaction.MOREDAIN),
    ALIGNMENT_TAUREDAIN(LOTRFaction.TAUREDAIN),
    ...
    private LOTRShields(boolean hidden, String... players) {
        this(ShieldType.EXCLUSIVE, hidden, players);
    }

    private LOTRShields(ShieldType type, boolean hidden, String... players) {
    ...
    public static enum ShieldType {
        ...
        public List<LOTRShields> list = new ArrayList<LOTRShields>();

...
public class LOTREntities {
    ...
    public static void registerEntities() {
        ...
        LOTREntities.registerCreature(LOTREntityUruk_dg.class, "Uruk_dg", 1003, 4408654, 2040101);
        
        LOTREntities.registerCreature(LOTREntityKhand.class, "Khand", 1010, 15759685, 15759686);
        LOTREntities.registerCreature(LOTREntityKhandSoldier.class, "KhandSoldier", 1011, 15759685, 15759686);
        LOTREntities.registerCreature(LOTREntityKhandBannerBearer.class, "KhandBannerBearer", 1012, 15759685, 15759686);
        LOTREntities.registerCreature(LOTREntityKhandArcher.class, "KhandArcher", 1013, 15759685, 15759686);
        LOTREntities.registerCreature(LOTREntityKhandSmith.class, "KhandSmith", 1014, 15759685, 15759686);
        LOTREntities.registerCreature(LOTREntityKhandCommander.class, "KhandCommander", 1015, 15759685, 15759686);
        
        LOTREntities.registerCreature(LOTREntityDarkWoodElf.class, "DarkWood", 1020, 6562513, 9118417);
        LOTREntities.registerCreature(LOTREntityDarkWoodSoldierElf.class, "Dark_WoodSoldier", 1021, 6562513, 9118417);
        LOTREntities.registerCreature(LOTREntityDarkWoodBannerBearer.class, "DarkWoodBannerBearer", 1022, 6562513, 9118417);
        LOTREntities.registerCreature(LOTREntityDarkWoodfSmith.class, "DarkWoodSmith", 1023, 6562513, 9118417);
        LOTREntities.registerCreature(LOTREntityDarkWoodCommander.class, "DarkWoodCommander", 1024, 6562513, 9118417);
        
        LOTREntities.registerCreature(LOTREntityNumenor.class, "Numenor", 1030, 15790838, 15790837);
        LOTREntities.registerCreature(LOTREntityNumenorSoldier.class, "NumenorrSoldier", 1031, 15790838, 15790837);
        LOTREntities.registerCreature(LOTREntityNumenorBannerBearer.class, "NumenorrBannerBearer", 1032, 15790838, 15790837);
        LOTREntities.registerCreature(LOTREntityNumenorArcher.class, "NumenorArcher", 1033, 15790838, 15790837);
        LOTREntities.registerCreature(LOTREntityNumenorSmith.class, "NumenorSmith", 1034, 15790838, 15790837);
        LOTREntities.registerCreature(LOTREntityNumenorCommander.class, "NumenorCommander", 1035, 15790838, 15790837);
        LOTREntities.registerCreature(LOTREntityNumenorLevyman.class, "NumenorLevyman", 1036, 15790838, 15790837);
        LOTREntities.registerCreature(LOTREntityNumenorBartender.class, "NumenorLevyman", 1037, 15790838, 15790837);
        LOTREntities.registerCreature(LOTREntityNumenorFarmhand.class, "NumenorFarmhand", 1038, 15790838, 15790837);
        LOTREntities.registerCreature(LOTREntityNumenorFarmer.class, "NumenorFarmhand", 1039, 15790838, 15790837);
        
        
        LOTREntities.registerCreature(LOTREntityNumenorGreengrocer.class, "NumenorGreengrocer", 1340, 13547685, 5652538);
        LOTREntities.registerCreature(LOTREntityNumenorLumberman.class, "NumenorLumberman", 1341, 13547685, 5652538);
        LOTREntities.registerCreature(LOTREntityNumenorMason.class, "NumenorMason", 1341, 13547685, 5652538);
        LOTREntities.registerCreature(LOTREntityNumenorBrewer.class, "NumenorBrewer", 1342, 13547685, 5652538);
        LOTREntities.registerCreature(LOTREntityNumenorFlorist.class, "NumenorFlorist", 1343, 13547685, 5652538);
        LOTREntities.registerCreature(LOTREntityNumenorButcher.class, "NumenorButcher", 1344, 13547685, 5652538);
        LOTREntities.registerCreature(LOTREntityNumenorFishmonger.class, "NumenorFishmonger", 1345, 13547685, 5652538);
        LOTREntities.registerCreature(LOTREntityNumenorBaker.class, "NumenorBaker", 1346, 13547685, 5652538);
        ...
        LOTREntities.registerCreature(LOTREntityRedDwarf.class, "RedDwarf", 1040, 16063760, 12653121);
        LOTREntities.registerCreature(LOTREntityRedDwarfSmith.class, "RedDwarfSmith", 1041, 16063760, 12653121);
        LOTREntities.registerCreature(LOTREntityRedDwarfMerchant.class, "RedDwarfMerchant", 1042, 16063760, 12653121);
        LOTREntities.registerCreature(LOTREntityRedDwarfCommander.class, "RedDwarfCommander", 1043, 16063760, 12653121);
        LOTREntities.registerCreature(LOTREntityRedDwarfWarrior.class, "RedDwarfWarrior", 1044, 16063760, 12653121);
        LOTREntities.registerCreature(LOTREntityRedDwarfAxeThrower.class, "RedDwarfAxeThrower", 1045, 16063760, 12653121);
        LOTREntities.registerCreature(LOTREntityRedDwarfBannerBearer.class, "RedDwarfBannerBearerr", 1046, 16063760, 12653121);

        LOTREntities.registerCreature(LOTREntityWindDwarf.class, "WindDwarf", 1050, 6733283, 12706555);
        LOTREntities.registerCreature(LOTREntityWindDwarfSmith.class, "WindDwarfSmith", 1051, 6733283, 12706555);
        LOTREntities.registerCreature(LOTREntityWindDwarfMerchant.class, "WindDwarfMerchant", 1052, 6733283, 12706555);
        LOTREntities.registerCreature(LOTREntityWindDwarfCommander.class, "WindDwarfCommander", 1053, 6733283, 12706555);
        LOTREntities.registerCreature(LOTREntityWindDwarfWarrior.class, "WindDwarfWarrior", 1054, 6733283, 12706555);
        LOTREntities.registerCreature(LOTREntityWindDwarfAxeThrower.class, "WindDwarfAxeThrower", 1055, 6733283, 12706555);
        LOTREntities.registerCreature(LOTREntityWindDwarfBannerBearer.class, "WindDwarfBannerBearer", 1056, 6733283, 12706555);
        ...
        LOTREntities.registerEntity(LOTREntityJavelin.class, "Javelin", 2036, 64, Integer.MAX_VALUE, false);

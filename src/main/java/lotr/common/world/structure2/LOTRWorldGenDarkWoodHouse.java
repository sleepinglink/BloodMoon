...
public class LOTRWorldGenDarkWoodHouse extends LOTRWorldGenStructureBase2 {
    ...
    public LOTRWorldGenDarkWoodHouse(boolean flag) {
        super(flag);
    }
    ...
    protected void setupRandomBlocks(Random random) {
        ...
        this.brickMeta = 5;
        this.brickSlabBlock = LOTRMod.slabSingle15;
        this.brickSlabMeta = 1;
        this.brickStairBlock = LOTRMod.stairsDarkwoodBrick1;
        this.brickWallBlock = LOTRMod.wallStoneV;
        this.brickWallMeta = 12;
        this.brickCarvedBlock = LOTRMod.pillar4;
        ...
        this.bedBlock = LOTRMod.darkWoodBed;
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        this.placeMug(world, random, 2, 2, 2, 1, LOTRFoods.WOOD_ELF_DRINK);
        ...
        for(i1 = -1; i1 <= 0; ++i1) {
            for(k13 = 2; k13 <= 3; ++k13) {
                this.setBlockAndMetadata(world, i1, 1, k13, Blocks.carpet, 7);
            }
        }
        int[] i17 = new int[] {5, 8};
        k13 = i17.length;
        ...
        for(i13 = 0; i13 <= 1; ++i13) {
            for(k13 = 7; k13 <= 8; ++k13) {
                this.setBlockAndMetadata(world, i13, 1, k13, Blocks.carpet, 14);
            }
        }
        ...
        for(i13 = -1; i13 <= 1; ++i13) {
            for(k13 = 1; k13 <= 7; ++k13) {
                ...
                if(i2 == 0 && k2 <= 2 || i2 == 1 && k2 == 0) {
                    this.setBlockAndMetadata(world, i13, 6, k13, Blocks.carpet, 7);
                    continue;
                }
                if((i2 != 0 || k2 != 3) && (i2 != 1 || k2 != 1)) continue;
                this.setBlockAndMetadata(world, i13, 6, k13, Blocks.carpet, 14);
            }
        }
        int[] i19 = new int[] {-2, 2};
        k13 = i19.length;
        ...
        this.placeMug(world, random, -2, 7, 5, 3, LOTRFoods.WOOD_ELF_DRINK);
        ...
        this.placeBarrel(world, random, 2, 7, 7, 5, LOTRFoods.WOOD_ELF_DRINK);
        if(leafy) {
    ...
    protected ItemStack getElfFramedItem(Random random) {
        ItemStack[] items = new ItemStack[] {new ItemStack(LOTRMod.helmet_darkwood),
		new ItemStack(LOTRMod.body_darkwood), new ItemStack(LOTRMod.legs_darkwood),
		new ItemStack(LOTRMod.boots_darkwood), new ItemStack(LOTRMod.daggerDarkwood),
		new ItemStack(LOTRMod.swordDarkwood), new ItemStack(LOTRMod.spearDarkwood),
		new ItemStack(LOTRMod.pikeDarkwood), new ItemStack(LOTRMod.darkwoodBow), 
		new ItemStack(Items.arrow), new ItemStack(Items.feather), new ItemStack(LOTRMod.swanFeather),
		new ItemStack(LOTRMod.goldRing)}; return items[random.nextInt(items.length)].copy();

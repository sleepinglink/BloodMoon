...
public class LOTRVillageGenRhun extends LOTRVillageGen {
    ...
    public class Instance extends LOTRVillageGen.AbstractInstance {
        ...
        protected void setupVillageProperties(Random random) {
            ...
            this.villageType = random.nextInt(4) == 0 ? VillageType.FORT : (LOTRVillageGenRhun.this.enableTowns && random.nextInt(4) == 0 ? VillageType.TOWN : VillageType.VILLAGE);
        }

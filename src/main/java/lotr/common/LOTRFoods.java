...
public class LOTRFoods {
	public static LOTRFoods  RED_MOUNTAINS = new LOTRFoods(new ItemStack[]{new ItemStack(Items.cooked_porkchop), new ItemStack(Items.cooked_fished), new ItemStack(Items.cooked_chicken), new ItemStack(Items.cooked_beef), new ItemStack(LOTRMod.muttonCooked), new ItemStack(LOTRMod.gammon), new ItemStack(Items.bread)});
	public static LOTRFoods  Wind_MOUNTAINS = new LOTRFoods(new ItemStack[]{new ItemStack(Items.cooked_porkchop), new ItemStack(Items.cooked_fished), new ItemStack(Items.cooked_chicken), new ItemStack(Items.cooked_beef), new ItemStack(LOTRMod.muttonCooked), new ItemStack(LOTRMod.gammon), new ItemStack(Items.bread)});
    ...
    public ItemStack getRandomFoodForPlate(Random random) {
        ArrayList<ItemStack> foodsNoContainer = new ArrayList<ItemStack>();
    ...
    public LOTRFoods setDrinkVessels(LOTRItemMug.Vessel... vessels) {
        ...
        ArrayList<LOTRItemMug.Vessel> placeable = new ArrayList<LOTRItemMug.Vessel>();
        for(LOTRItemMug.Vessel v : this.drinkVessels) {
            if(!v.canPlace) continue;
            placeable.add(v);
        }
        this.drinkVesselsPlaceable = !placeable.isEmpty() ? placeable.toArray(new LOTRItemMug.Vessel[0]) : new LOTRItemMug.Vessel[] {LOTRItemMug.Vessel.MUG};
        return this;
    }
    ...
    public ItemStack getRandomBrewableDrink(Random random) {
        ArrayList<ItemStack> alcohols = new ArrayList<ItemStack>();
        for(ItemStack itemstack : this.foodList) {
            Item item = itemstack.getItem();

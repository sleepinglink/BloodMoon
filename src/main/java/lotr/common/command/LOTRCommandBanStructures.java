...
public class LOTRCommandBanStructures extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) {
        if(args.length == 0) {
            ...
            CommandBase.func_152373_a(sender, this, "commands.lotr.banStructures.ban", new Object[0]);
        }
        else {
            ...
            if(entityplayer != null) {
                entityplayer.addChatMessage(new ChatComponentTranslation("chat.lotr.banStructures", new Object[0]));
            }
        }
    }

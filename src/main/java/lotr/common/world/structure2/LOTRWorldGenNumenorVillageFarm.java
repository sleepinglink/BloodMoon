...
public abstract class LOTRWorldGenNumenorVillageFarm extends LOTRWorldGenNumenorStructure {
    public LOTRWorldGenNumenorVillageFarm(boolean flag) {
        super(flag);
    }
    ...
    public static class Tree extends LOTRWorldGenNumenorVillageFarm {
    ...
    public static class Animals extends LOTRWorldGenNumenorVillageFarm {
    ...
    public static class Crops extends LOTRWorldGenNumenorVillageFarm {

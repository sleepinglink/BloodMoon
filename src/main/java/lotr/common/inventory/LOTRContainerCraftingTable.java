...
public abstract class LOTRContainerCraftingTable extends ContainerWorkbench {
    ...
    public static class RED_MOUNTAIN extends LOTRContainerCraftingTable {
        public RED_MOUNTAIN(InventoryPlayer inv, World world, int i, int j, int k) {
            super(inv, world, i, j, k, LOTRRecipes.red_mountainsRecipes, LOTRMod.red_dwarven_table);
        }
    }
    public static class WIND_MOUNTAIN extends LOTRContainerCraftingTable {
        public WIND_MOUNTAIN(InventoryPlayer inv, World world, int i, int j, int k) {
            super(inv, world, i, j, k, LOTRRecipes.wind_mountainsRecipes, LOTRMod.wind_dwarven_table);
        }
    }
    public static class KHAND extends LOTRContainerCraftingTable {
        public KHAND(InventoryPlayer inv, World world, int i, int j, int k) {
            super(inv, world, i, j, k, LOTRRecipes.khandRecipes, LOTRMod.khand_table);
        }
    }
    public static class DARK_WOOD extends LOTRContainerCraftingTable {
        public DARK_WOOD(InventoryPlayer inv, World world, int i, int j, int k) {
            super(inv, world, i, j, k, LOTRRecipes.dark_woodRecipes, LOTRMod.darkwood_table);
        }
    }
    public static class NUMENOR extends LOTRContainerCraftingTable {
        public NUMENOR(InventoryPlayer inv, World world, int i, int j, int k) {
            super(inv, world, i, j, k, LOTRRecipes.numenorRecipes, LOTRMod.numenor_table);
        }
    }

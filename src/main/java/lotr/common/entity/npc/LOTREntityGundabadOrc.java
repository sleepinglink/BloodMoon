...
public class LOTREntityGundabadOrc extends LOTREntityOrc {
    ...
    private static ItemStack[] helmets = new ItemStack[] {new ItemStack(LOTRMod.helmet_gund)};
    private static ItemStack[] bodies = new ItemStack[] {new ItemStack(LOTRMod.body_gund)};
    private static ItemStack[] legs = new ItemStack[] {new ItemStack(LOTRMod.legs_gund)};
    private static ItemStack[] boots = new ItemStack[] {new ItemStack(LOTRMod.boots_gund)};

...
public class LOTRBlockChandelier extends Block {
    ...
    private String[] chandelierNames = new String[] {"bronze", "iron", "silver", "gold", "mithril", "mallornSilver", "woodElven", "orc",
    		"dwarven", "uruk", "highElven", "blueDwarven", "morgul", "mallornBlue", "mallornGold", "mallornGreen", "redDwarven", "windDwarven" };

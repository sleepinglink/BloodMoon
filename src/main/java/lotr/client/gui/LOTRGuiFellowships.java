...
public class LOTRGuiFellowships extends LOTRGuiMenuBase {
    ...
    private void refreshFellowshipList() {
        ...
        ArrayList<LOTRFellowshipClient> fellowships = new ArrayList<LOTRFellowshipClient>(LOTRLevelData.getData(this.mc.thePlayer).getClientFellowships());
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        this.buttonCreate.enabled = this.buttonCreate.visible && canCreateNew;

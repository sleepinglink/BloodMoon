...
public class LOTRClientProxy extends LOTRCommonProxy {
    ...
    public static ResourceLocation customEffectsTexture = new ResourceLocation("lotr:gui/effects.png");
    ...
    public void onPreload() {
        ...
        try {
            for(Field field : LOTRMod.class.getFields()) {
                ...
                LOTRRenderLargeItem largeItemRenderer = LOTRRenderLargeItem.getLargeIconSize(item);
                ...
                if(item instanceof LOTRItemSword && ((LOTRItemSword) item).isElvenBlade()) {
                    double d = 24.0;
...
RenderingRegistry.registerEntityRenderingHandler(LOTREntityJavelin.class, new LOTRRenderJavelin());
...
RenderingRegistry.registerEntityRenderingHandler(LOTREntityKhand.class, new LOTRRenderKhand());
RenderingRegistry.registerEntityRenderingHandler(LOTREntityDarkWoodElf.class, new LOTRRenderElf());
RenderingRegistry.registerEntityRenderingHandler(LOTREntityNumenor.class, new LOTRRenderNumenor());


RenderingRegistry.registerEntityRenderingHandler(LOTREntityRedDwarf.class, new LOTRRenderDwarf());
RenderingRegistry.registerEntityRenderingHandler(LOTREntityRedDwarfSmith.class, new LOTRRenderDwarfSmith());
RenderingRegistry.registerEntityRenderingHandler(LOTREntityRedDwarfCommander.class, new LOTRRenderDwarfCommander());
RenderingRegistry.registerEntityRenderingHandler(LOTREntityRedDwarfMerchant.class, new LOTRRenderDwarfCommander());

RenderingRegistry.registerEntityRenderingHandler(LOTREntityWindDwarf.class, new LOTRRenderDwarf());
RenderingRegistry.registerEntityRenderingHandler(LOTREntityWindDwarfSmith.class, new LOTRRenderDwarfSmith());
RenderingRegistry.registerEntityRenderingHandler(LOTREntityWindDwarfCommander.class, new LOTRRenderDwarfCommander());
RenderingRegistry.registerEntityRenderingHandler(LOTREntityWindDwarfMerchant.class, new LOTRRenderDwarfCommander());
...
ClientRegistry.bindTileEntitySpecialRenderer(LOTRTileEntitySignCarvedIthildin.class, new LOTRRenderSignCarvedIthildin());
    ...
    public static int getAlphaInt(float alphaF) {
        ...
        alphaI = MathHelper.clamp_int(alphaI, FONTRENDERER_ALPHA_MIN, 255);
        return alphaI;
    }
    ...
    @Override
    public void spawnAlignmentBonus(LOTRFaction faction, float prevMainAlignment, LOTRAlignmentBonusMap factionBonusMap, String name, boolean isKill, float conquestBonus, double posX, double posY, double posZ) {
        World world = this.getClientWorld();
        if(world != null) {
            LOTREntityAlignmentBonus entity = new LOTREntityAlignmentBonus(world, posX, posY, posZ, name, faction, prevMainAlignment, factionBonusMap, isKill, conquestBonus);

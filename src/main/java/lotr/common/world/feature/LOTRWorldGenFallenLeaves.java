...
public class LOTRWorldGenFallenLeaves extends WorldGenerator {
    ...
    public boolean generate(World world, Random random, int i, int j, int k) {
        ...
        for(l = 0; l < 40; ++l) {
            ...
            if(!(block instanceof BlockLeavesBase) || (obj = LOTRBlockFallenLeaves.fallenBlockMetaFromLeafBlockMeta(block, meta = world.getBlockMetadata(i1, j1, k1))) == null) continue;
        ...
        for(l = 0; l < 64; ++l) {
            ...
            if(!fallenLeaf.canBlockStay(world, i1, j1, k1) || block.getMaterial().isLiquid() || !block.isReplaceable(world, i1, j1, k1)) continue;

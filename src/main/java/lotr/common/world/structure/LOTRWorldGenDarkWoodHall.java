...
import lotr.common.entity.npc.LOTREntityDarkWoodElf;
...
public class LOTRWorldGenDarkWoodHall extends LOTRWorldGenStructureBase {
    ...
    protected Block tableBlock = LOTRMod.darkwood_table;
    protected Block plateBlock = LOTRMod.plateBlock;
    protected LOTRItemBanner.BannerType bannerType = LOTRItemBanner.BannerType.DARK_WOOD;
    protected LOTRChestContents chestContents = LOTRChestContents2.DARKWOOD_HALL;

    public LOTRWorldGenDarkWoodHall(boolean flag) {
        super(flag);
    }
    ...
    public boolean generate(World world, Random random, int i, int j, int k) {
        ...
        for(i14 = i; i14 <= i + 15; ++i14) {
            for(k14 = k; k14 <= k + 15; ++k14) {
                for(j12 = j; !(j12 != j && LOTRMod.isOpaque(world, i14, j12, k14) || j12 < 0); --j12) {
                    this.setBlockAndNotifyAdequately(world, i14, j12, k14, LOTRMod.brick7, 5);
                ...
                if(i14 < i + 2 || i14 > i + 13 || k14 < k + 2 || k14 > k + 13) {
                    this.setBlockAndNotifyAdequately(world, i14, j + 5, k14, LOTRMod.brick7, 5);
                }
                else {
        ...
        for(i14 = i + 1; i14 <= i + 14; ++i14) {
            this.setBlockAndNotifyAdequately(world, i14, j + 6, k, LOTRMod.wallStoneV, 12);
            this.setBlockAndNotifyAdequately(world, i14, j + 6, k + 15, LOTRMod.wallStoneV, 12);
        }
        for(int k15 = k + 1; k15 <= k + 14; ++k15) {
            this.setBlockAndNotifyAdequately(world, i, j + 6, k15, LOTRMod.brick7, 5);
            this.setBlockAndNotifyAdequately(world, i, j + 7, k15, LOTRMod.wallStoneV, 12);
            this.setBlockAndNotifyAdequately(world, i + 15, j + 6, k15, LOTRMod.wallStoneV, 12);
        }
            ...
            for(k14 = k; k14 <= k + 15; k14 += 15) {
                ...
                for(i15 = i; i15 <= i + 15; i15 += 3) {
                    for(j2 = j14 + 1; j2 <= j14 + 4; ++j2) {
                        this.setBlockAndNotifyAdequately(world, i15, j2, k14, LOTRMod.pillar4, 0);
                    }
                    this.setBlockAndNotifyAdequately(world, i15, j14 + 5, k14, LOTRMod.brick7, 5);
                }
                for(i15 = i + 1; i15 <= i + 13; i15 += 3) {
                    this.setBlockAndNotifyAdequately(world, i15, j14 + 5, k14, LOTRMod.stairsDarkwoodBrick1, 5);
                    this.setBlockAndNotifyAdequately(world, i15 + 1, j14 + 5, k14, LOTRMod.stairsDarkwoodBrick1, 4);
                }
            }
            for(i12 = i; i12 <= i + 15; i12 += 15) {
                for(k1 = k + 3; k1 <= k + 12; k1 += 3) {
                    for(j2 = j14 + 1; j2 <= j14 + 4; ++j2) {
                        this.setBlockAndNotifyAdequately(world, i12, j2, k1, LOTRMod.pillar4, 0);
                    }
                    this.setBlockAndNotifyAdequately(world, i12, j14 + 5, k1, LOTRMod.brick7, 5);
                }
                for(k1 = k + 1; k1 <= k + 13; k1 += 3) {
                    this.setBlockAndNotifyAdequately(world, i12, j14 + 5, k1, LOTRMod.stairsDarkwoodBrick1, 7);
                    this.setBlockAndNotifyAdequately(world, i12, j14 + 5, k1 + 1, LOTRMod.stairsDarkwoodBrick1, 6);
                }
            }
            for(i12 = i; i12 <= i + 15; i12 += 3) {
                this.setBlockAndNotifyAdequately(world, i12, j14 + 4, k + 1, Blocks.torch, 0);
                this.setBlockAndNotifyAdequately(world, i12, j14 + 4, k + 14, Blocks.torch, 0);
            }
            for(k14 = k; k14 <= k + 15; k14 += 3) {
                this.setBlockAndNotifyAdequately(world, i + 1, j14 + 4, k14, Blocks.torch, 0);
                this.setBlockAndNotifyAdequately(world, i + 14, j14 + 4, k14, Blocks.torch, 0);
            }
        }
        int roofWidth = 18;
        int roofX = i - 1;
        ...
        this.setBlockAndNotifyAdequately(world, i + 2, j + 6, k + 9, LOTRMod.darkWoodBed, 1);
        this.setBlockAndNotifyAdequately(world, i + 1, j + 6, k + 9, LOTRMod.darkWoodBed, 9);
        ...
        this.placeMug(world, random, i + 1, j + 7, k + 4, 1, LOTRFoods.WOOD_ELF_DRINK);
        ...
        for(k13 = k + 5; k13 <= k + 6; ++k13) {
            for(j1 = j + 1; j1 <= j + 4; ++j1) {
                this.setBlockAndNotifyAdequately(world, i + 7, j1, k13, LOTRMod.brick7, 5);
            }
            this.setBlockAndNotifyAdequately(world, i + 7, j + 5, k13, LOTRMod.stairsDarkwoodBrick1, 1);
            for(i1 = i + 8; i1 <= i + 10; ++i1) {
                for(int j15 = j + 1; j15 <= j + 3; ++j15) {
                    this.setBlockAndNotifyAdequately(world, i1, j15, k13, LOTRMod.brick7, 5);
                }
            }
            this.setBlockAndNotifyAdequately(world, i + 8, j + 4, k13, LOTRMod.stairsDarkwoodBrick1, 1);
        }
        for(i13 = i + 9; i13 <= i + 10; ++i13) {
            for(j1 = j + 1; j1 <= j + 2; ++j1) {
                this.setBlockAndNotifyAdequately(world, i13, j1, k + 7, LOTRMod.brick7, 5);
            }
            this.setBlockAndNotifyAdequately(world, i13, j + 3, k + 7, LOTRMod.stairsDarkwoodBrick1, 3);
            this.setBlockAndNotifyAdequately(world, i13, j + 1, k + 8, LOTRMod.brick7, 5);
            this.setBlockAndNotifyAdequately(world, i13, j + 2, k + 8, LOTRMod.stairsDarkwoodBrick1, 3);
            this.setBlockAndNotifyAdequately(world, i13, j + 1, k + 9, LOTRMod.stairsDarkwoodBrick1, 3);
        }
        this.setBlockAndNotifyAdequately(world, i + 11, j + 1, k + 5, LOTRMod.pillar4, 0);
        this.setBlockAndNotifyAdequately(world, i + 11, j + 1, k + 6, this.tableBlock, 0);
        this.setBlockAndNotifyAdequately(world, i + 11, j + 1, k + 7, LOTRMod.pillar4, 0);
        ...
        this.setBlockAndNotifyAdequately(world, i + 11, j + 3, k + 6, Blocks.torch, 0);
        this.setBlockAndNotifyAdequately(world, i + 6, j + 3, k + 6, Blocks.torch, 0);
        this.setBlockAndNotifyAdequately(world, i + 8, j + 3, k + 7, Blocks.torch, 0);
        this.setBlockAndNotifyAdequately(world, i + 10, j + 1, k + 4, LOTRMod.pillar4, 0);
        this.placeBarrel(world, random, i + 10, j + 2, k + 4, 2, LOTRFoods.WOOD_ELF_DRINK);
        this.setBlockAndNotifyAdequately(world, i + 7, j + 1, k + 4, LOTRMod.pillar4, 0);
        this.placeBarrel(world, random, i + 7, j + 2, k + 4, 2, LOTRFoods.WOOD_ELF_DRINK);
        ...
        for(k13 = k + 7; k13 <= k + 11; k13 += 2) {
            ...
            this.placeMug(world, random, i + 2, j + 2, k13, 3, LOTRFoods.WOOD_ELF_DRINK);
            this.placeMug(world, random, i + 4, j + 2, k13, 1, LOTRFoods.WOOD_ELF_DRINK);
        }
        this.placeMug(world, random, i + 3, j + 2, k + 6, 0, LOTRFoods.WOOD_ELF_DRINK);
        this.placeMug(world, random, i + 3, j + 2, k + 12, 2, LOTRFoods.WOOD_ELF_DRINK);

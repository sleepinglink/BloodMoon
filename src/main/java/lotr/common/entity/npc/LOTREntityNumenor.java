...
public class LOTREntityNumenor extends LOTREntityGondorMan{
	 private static ItemStack[] weapons = new ItemStack[] {new ItemStack(LOTRMod.daggerNumenor), new ItemStack(LOTRMod.daggerIron), new ItemStack(LOTRMod.daggerBronze)};

	    public LOTREntityNumenor(World world) {
	        super(world);
	    ...
	    public LOTRNPCMount createMountToRide() {
	        ...
	        horse.setMountArmor(new ItemStack(LOTRMod.horseArmorNumenor));
	        return horse;
	    }
	    ...
	    protected LOTRAchievement getKillAchievement() {
	        return LOTRAchievement.killNumenor;
	    }
	    ...
	    public String getSpeechBank(EntityPlayer entityplayer) {
	        if(this.isDrunkard()) {
	            return "numenor/drunkard/neutral";
	        }
	        if(this.isFriendly(entityplayer)) {
	            return "numenor/man/friendly";
	        }
	        return "numenor/man/hostile";
	    }

	    @Override
	    public LOTRMiniQuest createMiniQuest() {
	        return LOTRMiniQuestFactory.NUMENOR.createQuest(this);
	    }

	    @Override
	    public LOTRMiniQuestFactory getBountyHelpSpeechDir() {
	        return LOTRMiniQuestFactory.NUMENOR;
	    }
	}
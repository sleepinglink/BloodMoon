...
public class LOTRBiomeGenUmbar extends LOTRBiome {
    ...
    public LOTRBiomeGenUmbar(int i, boolean major) {
        ...
        arrspawnListContainer2[2] = LOTRBiomeSpawnList.entry(LOTRSpawnList.GONDOR_RENEGADE, 2);
    ...
    public void generateBiomeTerrain(World world, Random random, Block[] blocks, byte[] meta, int i, int k, double stoneNoise, int height, LOTRBiomeVariant variant) {
        ...
        if(d4 + (d5 = noiseSand.func_151601_a(i * 0.07, k * 0.07)) + (d6 = noiseSand.func_151601_a(i * 0.25, k * 0.25)) > 1.1) {

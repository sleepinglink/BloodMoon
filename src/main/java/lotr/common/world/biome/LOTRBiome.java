...
public abstract class LOTRBiome extends BiomeGenBase {
    ...
    public static LOTRBiome fertile_khand;
    public static LOTRBiome Semidesert_khand;
    ...
    public static LOTRBiome forestnumenor;
    ...
    public static LOTRBiome ForestMinhiriata;
    public static LOTRBiome ForestEnedwaita;
    public static LOTRBiome ExtremeRune;
    public static LOTRBiome MiddleRune;
    public static LOTRBiome CoastForochel;
    ...
    public static void initBiomes() {
        ...
        menel = new LOTRBiomeGenMenel(37, false).setTemperatureRainfall(0.9f, 0.8f).setMinMaxHeight(0.1f, 0.2f).setColor(9549658).setBiomeName("meneltarma");
        ...
        fertile_khand = new LOTRBiomeGenKhand(174, true).setTemperatureRainfall(1.5f, 0.2f).setMinMaxHeight(0.2f, 0.1f).setColor(12493893).setBiomeName("fertile_khand");
        Semidesert_khand = new LOTRBiomeGenSemidesertKhand(175, true).setTemperatureRainfall(1.5f, 0.2f).setMinMaxHeight(0.2f, 0.1f).setColor(13217615).setBiomeName("Semidesert_khand");
        forestnumenor = new LOTRBiomeGenForestNumenor(177, false).setTemperatureRainfall(0.9f, 0.8f).setMinMaxHeight(0.1f, 0.2f).setColor(5272634).setBiomeName("forestnumenor");
        ForestMinhiriata = new LOTRBiomeGenEnedwaithForest(178, true).setTemperatureRainfall(0.6f, 0.8f).setMinMaxHeight(0.2f, 0.3f).setColor(6458938).setBiomeName("ForestMinhiriata");
        ForestEnedwaita = new LOTRBiomeGenEnedwaithForest(179, true).setTemperatureRainfall(0.6f, 0.8f).setMinMaxHeight(0.2f, 0.3f).setColor(7314756).setBiomeName("ForestEnedwaita");
        ExtremeRune = new LOTRBiomeGenRhun(180, true).setTemperatureRainfall(0.9f, 0.3f).setMinMaxHeight(0.3f, 0.0f).setColor(11055704).setBiomeName("ExtremeRune");
        CoastForochel = new LOTRBiomeGenTaiga(181, true).setTemperatureRainfall(0.1f, 0.7f).setMinMaxHeight(0.1f, 0.5f).setColor(13684941).setBiomeName("CoastForochel");
        MiddleRune = new LOTRBiomeGenRhun(182, true).setTemperatureRainfall(0.9f, 0.3f).setMinMaxHeight(0.3f, 0.0f).setColor(10729302).setBiomeName("MiddleRune");
    }
    ...
    public void generateBiomeTerrain(World world, Random random, Block[] blocks, byte[] meta, int i, int k, double stoneNoise, int height, LOTRBiomeVariant variant) {
        ...
        if(this.enableRocky && height >= 90) {
            ...
            if(d12 + (d2 = biomeTerrainNoise.func_151601_a(i * 0.3, k * 0.3)) > thresh) {
        ...
        if((marsh = variant.hasMarsh) && (d1 = LOTRBiomeVariant.marshNoise.func_151601_a(i * 0.1, k * 0.1)) > -0.1) {

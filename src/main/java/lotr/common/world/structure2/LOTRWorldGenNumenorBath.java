...
public class LOTRWorldGenNumenorBath extends LOTRWorldGenNumenorStructure {
    public LOTRWorldGenNumenorBath(boolean flag) {
        super(flag);
    }

    protected LOTREntityNPC createBather(World world) {
        return new LOTREntityNumenor(world);
    }

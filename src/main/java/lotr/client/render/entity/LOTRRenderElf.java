...
public class LOTRRenderElf extends LOTRRenderBiped {
    ...
    private static LOTRRandomSkins darkwoodSkinsMale;
    private static LOTRRandomSkins darkwoodSkinsFemale;
    ...
    public LOTRRenderElf() {
        ...
        darkwoodSkinsMale = LOTRRandomSkins.loadSkinsList("lotr:mob/elf/darkwood_male");
        darkwoodSkinsFemale = LOTRRandomSkins.loadSkinsList("lotr:mob/elf/darkwood_female");
    }
    ...
    public ResourceLocation getEntityTexture(Entity entity) {
        ...
        if(elf instanceof LOTREntityDarkWoodElf) {
            if(male) {
                return darkwoodSkinsMale.getRandomSkin(elf);
            }
            return darkwoodSkinsFemale.getRandomSkin(elf);
        }

...
public class LOTRWorldGenWindMountainsStronghold extends LOTRWorldGenStructureBase{
	 public LOTRWorldGenWindMountainsStronghold(boolean flag) {
	      super(flag);
	   }
	    ...
	    public boolean generate(World world, Random random, int i, int j, int k) {
	        ...
	        for(k1 = k - 6; k1 <= k + 6; ++k1) {
	            for(i12 = i - 6; i12 <= i + 6; ++i12) {
	                ...
	                for(int j1 = j + 7; !(j1 < j && LOTRMod.isOpaque(world, i12, j1, k1) || j1 < 0); --j1) {
	                    if(flag) {
	                        this.setBlockAndNotifyAdequately(world, i12, j1, k1, LOTRMod.pillar5, 0);
	                    }
	                    else {
	                        ...
	                        this.setBlockAndNotifyAdequately(world, i12, j1, k1, LOTRMod.brick7, 6);
	                    }
	                    if(j1 > j) continue;
	        ...
	        for(k1 = k - 5; k1 <= k + 5; ++k1) {
	            for(i12 = i - 5; i12 <= i + 5; ++i12) {
	                this.setBlockAndNotifyAdequately(world, i12, j + 4, k1, LOTRMod.slabDouble15, 4);
	                this.setBlockAndNotifyAdequately(world, i12, j + 8, k1, LOTRMod.slabDouble15, 4);
	                ...
	                this.setBlockAndNotifyAdequately(world, i12, j + 9, k1, LOTRMod.wallStoneV, 13);
	            }
	        }
	        ...
	        this.setBlockAndNotifyAdequately(world, i, j + 7, k, LOTRMod.chandelier, 16);
	        this.setBlockAndNotifyAdequately(world, i, j + 11, k, LOTRMod.chandelier, 16);
	    ...
	    private void generateFacingSouth(World world, Random random, int i, int j, int k) {
	        ...
	        int i13;
	        for(i12 = i - 6; i12 <= i + 6; ++i12) {
	            this.setBlockAndNotifyAdequately(world, i12, j + 1, k - 7, LOTRMod.slabSingle15, 4);
	            this.setGrassToDirt(world, i12, j, k - 7);
	            for(j12 = j; !LOTRMod.isOpaque(world, i12, j12, k - 7) && j12 >= 0; --j12) {
	                this.setBlockAndNotifyAdequately(world, i12, j12, k - 7, LOTRMod.pillar5, 0);
	                this.setGrassToDirt(world, i12, j12 - 1, k - 7);
	            }
	        }
	        for(j1 = j + 1; j1 <= j + 2; ++j1) {
	            this.setAir(world, i, j1, k - 6);
	            this.setBlockAndNotifyAdequately(world, i - 1, j1, k - 7, LOTRMod.pillar5, 0);
	            this.setBlockAndNotifyAdequately(world, i + 1, j1, k - 7, LOTRMod.pillar5, 0);
	        }
	        ...
	        for(j1 = j + 1; j1 <= j + 3; ++j1) {
	            for(k1 = k - 4; k1 <= k - 1; ++k1) {
	                for(i1 = i - 5; i1 <= i - 1; ++i1) {
	                    this.setBlockAndNotifyAdequately(world, i1, j1, k1, LOTRMod.brick7, 6);
	                }
	            ...
	            for(k1 = k - 2; k1 <= k + 5; ++k1) {
	                this.setBlockAndNotifyAdequately(world, i - 1, j1, k1, LOTRMod.brick7, 6);
	                this.setBlockAndNotifyAdequately(world, i + 1, j1, k1, LOTRMod.brick7, 6);
	            }
	        }
	        ...
	        for(i12 = i - 5; i12 <= i + 2; i12 += 7) {
	            ...
	            LOTRChestContents.fillChest(world, random, i12 + 2, j + 1, k, LOTRChestContents.WIND_MOUNTAINS_STRONGHOLD);
	            this.setBlockAndNotifyAdequately(world, i12 + 1, j + 3, k + 3, LOTRMod.chandelier, 16);
	        ...
	        for(j12 = j + 1; j12 <= j + 4; ++j12) {
	            ...
	            for(j2 = j12 - 1; j2 > j; --j2) {
	                this.setBlockAndNotifyAdequately(world, i - stairX, j2, k - 5, LOTRMod.brick7, 6);
	                this.setBlockAndNotifyAdequately(world, i + stairX, j2, k - 5, LOTRMod.brick7, 6);
	            }
	            ++stairX;
	        }
	        for(j12 = j + 1; j12 <= j + 3; ++j12) {
	            this.setBlockAndNotifyAdequately(world, i - stairX, j12, k - 5, LOTRMod.brick7, 6);
	            this.setBlockAndNotifyAdequately(world, i + stairX, j12, k - 5, LOTRMod.brick7, 6);
	        }
	        for(i13 = i - 5; i13 <= i + 5; i13 += 10) {
	            ...
	            this.setBlockAndNotifyAdequately(world, i13, j + 5, k + 2, Blocks.planks, 1);
	            this.setBlockAndNotifyAdequately(world, i13, j + 6, k + 2, Blocks.wooden_slab, 1);
	            this.setBlockAndNotifyAdequately(world, i13, j + 5, k, LOTRMod.wind_dwarven_table, 0);
	        ...
	        this.setBlockAndNotifyAdequately(world, i, j + 4, k + 6, LOTRMod.slabDouble15, 4);
	        ...
	        this.setBlockAndNotifyAdequately(world, i, j + 3, k + 8, LOTRMod.chandelier, 16);
	    ...
	    private void generateFacingWest(World world, Random random, int i, int j, int k) {
	        ...
	        for(k13 = k - 6; k13 <= k + 6; ++k13) {
	            this.setBlockAndNotifyAdequately(world, i + 7, j + 1, k13, LOTRMod.slabSingle15, 4);
	            this.setGrassToDirt(world, i + 7, j, k13);
	            for(j12 = j; !LOTRMod.isOpaque(world, i + 7, j12, k13) && j12 >= 0; --j12) {
	                this.setBlockAndNotifyAdequately(world, i + 7, j12, k13, LOTRMod.pillar5, 0);
	                this.setGrassToDirt(world, i + 7, j12 - 1, k13);
	            }
	        }
	        for(j1 = j + 1; j1 <= j + 2; ++j1) {
	            this.setAir(world, i + 6, j1, k);
	            this.setBlockAndNotifyAdequately(world, i + 7, j1, k - 1, LOTRMod.pillar5, 0);
	            this.setBlockAndNotifyAdequately(world, i + 7, j1, k + 1, LOTRMod.pillar5, 0);
	        }
	        ...
	        this.placeWallBanner(world, i + 6, j + 6, k, 3, LOTRItemBanner.BannerType.WIND_MOUNTAINS);
	        for(j1 = j + 1; j1 <= j + 3; ++j1) {
	            for(i1 = i + 4; i1 >= i + 1; --i1) {
	                for(k12 = k - 5; k12 <= k - 1; ++k12) {
	                    this.setBlockAndNotifyAdequately(world, i1, j1, k12, LOTRMod.brick7, 6);
	                }
	            ...
	            for(i1 = i + 2; i1 >= i - 5; --i1) {
	                this.setBlockAndNotifyAdequately(world, i1, j1, k - 1, LOTRMod.brick7, 6);
	                this.setBlockAndNotifyAdequately(world, i1, j1, k + 1, LOTRMod.brick7, 6);
	            }
	        }
	        ...
	        for(k13 = k - 5; k13 <= k + 2; k13 += 7) {
	            ...
	            LOTRChestContents.fillChest(world, random, i, j + 1, k13 + 2, LOTRChestContents.WIND_MOUNTAINS_STRONGHOLD);
	            this.setBlockAndNotifyAdequately(world, i - 3, j + 3, k13 + 1, LOTRMod.chandelier, 16);
	        ...
	        for(k1 = k - 5; k1 <= k + 5; k1 += 10) {
	            ...
	            this.setBlockAndNotifyAdequately(world, i + 2, j + 5, k1, Blocks.planks, 1);
	            this.setBlockAndNotifyAdequately(world, i + 2, j + 6, k1, Blocks.wooden_slab, 1);
	            this.setBlockAndNotifyAdequately(world, i, j + 5, k1, LOTRMod.wind_dwarven_table, 0);
	        ...
	        this.setBlockAndNotifyAdequately(world, i - 6, j + 4, k, LOTRMod.slabDouble15, 4);
	        ...
	        this.setBlockAndNotifyAdequately(world, i - 8, j + 3, k, LOTRMod.chandelier, 16);
	        for(j12 = j + 1; j12 <= j + 2; ++j12) {
	    ...
	    private void generateFacingNorth(World world, Random random, int i, int j, int k) {
	        ...
	        this.setBlockAndNotifyAdequately(world, i + 1, j + 3, k + 7, LOTRMod.stairsDwarvenBrick, 1);
	        this.setBlockAndNotifyAdequately(world, i, j + 4, k + 7, LOTRMod.slabSingle, 7);
	        this.placeWallBanner(world, i, j + 6, k + 6, 0, LOTRItemBanner.BannerType.WIND_MOUNTAINS);
	        for(j1 = j + 1; j1 <= j + 3; ++j1) {
	            for(k1 = k + 4; k1 >= k + 1; --k1) {
	                for(i1 = i - 5; i1 <= i - 1; ++i1) {
	                    this.setBlockAndNotifyAdequately(world, i1, j1, k1, LOTRMod.brick7, 6);
	    ...
	    private void generateFacingEast(World world, Random random, int i, int j, int k) {
	        ...
	        this.setBlockAndNotifyAdequately(world, i - 7, j + 3, k + 1, LOTRMod.stairsDwarvenBrick, 3);
	        this.setBlockAndNotifyAdequately(world, i - 7, j + 4, k, LOTRMod.slabSingle, 7);
	        this.placeWallBanner(world, i - 6, j + 6, k, 1, LOTRItemBanner.BannerType.WIND_MOUNTAINS);
	        for(j1 = j + 1; j1 <= j + 3; ++j1) {
	            for(i1 = i - 4; i1 <= i - 1; ++i1) {
	                for(k12 = k - 5; k12 <= k - 1; ++k12) {
	                    this.setBlockAndNotifyAdequately(world, i1, j1, k12, LOTRMod.brick7, 6);
	    ...
	    private void spawnDwarfCommander(World world, int i, int j, int k) {
	        LOTREntityWindDwarfCommander dwarf = new LOTREntityWindDwarfCommander(world);
	    ...
	    private void spawnDwarf(World world, int i, int j, int k) {
	        LOTREntityWindDwarfWarrior dwarf = world.rand.nextInt(3) == 0 ? new LOTREntityWindDwarfAxeThrower(world) : new LOTREntityWindDwarfWarrior(world);
	        dwarf.setLocationAndAngles(i + 0.5, j, k + 0.5, 0.0f, 0.0f);
	        ((LOTREntityWindDwarf) dwarf).onSpawnWithEgg(null);
	    ...
	    private void placeBalconySection(World world, int i, int j, int k, boolean isEdge, boolean isPillar) {
	        if(isEdge) {
	            for(int j1 = j + 4; !(j1 < j && LOTRMod.isOpaque(world, i, j1, k) || j1 < 0); --j1) {
	                if(isPillar) {
	                    this.setBlockAndNotifyAdequately(world, i, j1, k, LOTRMod.pillar5, 0);
	                }
	                else {
	                    this.setBlockAndNotifyAdequately(world, i, j1, k, LOTRMod.brick7, 6);
	                }
	            ...
	            this.setBlockAndNotifyAdequately(world, i, j + 6, k, LOTRMod.wallStoneV, 13);
	        }
	        else {
	            int j1;
	            ...
	            this.setBlockAndNotifyAdequately(world, i, j + 4, k, LOTRMod.slabDouble15, 4);
	        }
	    }

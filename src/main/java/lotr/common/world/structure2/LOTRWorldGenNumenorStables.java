...
public class LOTRWorldGenNumenorStables extends LOTRWorldGenNumenorStructure {
    public LOTRWorldGenNumenorStables(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        if(random.nextInt(3) == 0) {
            this.placeChest(world, random, 3, 5, 1, 5, LOTRChestContents2.NUMENOR_HOUSE_TREASURE);
        }

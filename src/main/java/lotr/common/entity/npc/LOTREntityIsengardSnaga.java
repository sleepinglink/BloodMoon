...
public class LOTREntityIsengardSnaga extends LOTREntityOrc {
    ...
    private static ItemStack[] helmets = new ItemStack[] {new ItemStack(LOTRMod.helmet_snaga)};
    private static ItemStack[] bodies = new ItemStack[] {new ItemStack(LOTRMod.body_snaga)};
    private static ItemStack[] legs = new ItemStack[] {new ItemStack(LOTRMod.legs_snaga)};
    private static ItemStack[] boots = new ItemStack[] {new ItemStack(LOTRMod.boots_snaga)};

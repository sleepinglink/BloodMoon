...
public class LOTRWorldGenNumenorWatchfort extends LOTRWorldGenNumenorStructure {
    public LOTRWorldGenNumenorWatchfort(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        this.placeChest(world, random, 0, 2, 2, LOTRMod.chestLebethron, 3, LOTRChestContents2.NUMENOR_FORTRESS_SUPPLIES);

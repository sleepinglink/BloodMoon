...
public class LOTRGuiTitles extends LOTRGuiMenuBase {
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        if(this.selectedTitle != null) {
            String title = (this.selectedColor) + this.selectedTitle.getDisplayName();
    ...
    protected void mouseClicked(int i, int j, int mouse) {
        if(mouse == 0) {
            ...
            if(!this.displayedColorBoxes.isEmpty()) {
                for(Entry<EnumChatFormatting, Pair<Integer, Integer>> entry : this.displayedColorBoxes.entrySet()) {

...
public enum LOTRMapLabels {
    ...
    NUMENOR("numenor", 244, 2163, 4.0f, 0, -4.5f, 1.0f),
    ...
    HARNEDOR(LOTRBiome.harnedor, 1440, 1580, 3.0f, -3, -2.5f, 1.5f),
    ...
    PERTOROGWAITH(LOTRBiome.pertorogwaith, 1920, 2560, 5.0f, -10, -2.5f, 0.5f),
    ...
    private LOTRMapLabels(Object label, int x, int y, float f, int r, float z1, float z2) {
        this.posX = x;
        this.posY = y;
        this.scale = f;
        this.angle = r;

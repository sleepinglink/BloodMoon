...
public class LOTREntityRedDwarfCommander extends LOTREntityRedDwarfWarrior implements LOTRUnitTradeable{

	public LOTREntityRedDwarfCommander(World world) {
        super(world);
    ...
    public LOTRUnitTradeEntries getUnits() {
        return LOTRUnitTradeEntries.RED_DWARF_COMMANDER;
    }

    @Override
    public LOTRInvasions getConquestHorn() {
        return LOTRInvasions.RED_MOUNTAINS;
    }
    ...
    public void onUnitTrade(EntityPlayer entityplayer) {
        LOTRLevelData.getData(entityplayer).addAchievement(LOTRAchievement.tradeRedDwarfCommander);
    }

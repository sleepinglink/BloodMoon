...
public enum LOTRWaypoint implements LOTRAbstractWaypoint {
	Andynue(Region.MENELTARMA , LOTRFaction.NUMENOR, 123, 2146),
	Romenna(Region.MENELTARMA, LOTRFaction.NUMENOR, 306, 2178),
	Nindamos(Region.MENELTARMA, LOTRFaction.NUMENOR, 275, 2255),
	Armanalos(Region.MENELTARMA, LOTRFaction.NUMENOR, 274, 2187),
	Almaida(Region.MENELTARMA, LOTRFaction.NUMENOR, 91, 2153),

	NARAG_GUND( Region.RED_MOUNTAINS, LOTRFaction.RED_MOUNTAINS, 2579, 1262),
    KHIBIL_TARAG( Region.RED_MOUNTAINS, LOTRFaction.RED_MOUNTAINS, 2448, 952),
    KHELED_DUM(Region.RED_MOUNTAINS, LOTRFaction.RED_MOUNTAINS, 2382, 570),
    BRAGAZGATHOL(Region.WIND_MOUNTAINS, LOTRFaction.WIND_MOUNTAINS, 2362, 1573),
    BARAZ_DUM(Region.RED_MOUNTAINS, LOTRFaction.RED_MOUNTAINS, 2326, 800),
    
    Sheim_ar_fling(Region.KHAND, LOTRFaction.KHAND,2099, 1448),
    Sheim_o_pong(Region.KHAND, LOTRFaction.KHAND,1889, 1351),
    Beit_Guvrin(Region.KHAND, LOTRFaction.KHAND,1919, 1372),
    
    Lurt_draiar(Region.RHUN, LOTRFaction.DARK_WOOD,2486 , 1089),
    Chain_nasad(Region.RHUN, LOTRFaction.DARK_WOOD,2442 , 1003),
    Baragx_ungol(Region.RHUN, LOTRFaction.DARK_WOOD,2454 , 1054),
	Marzoberrezen(Region.RHUN, LOTRFaction.DARK_WOOD,2358 , 915),
    
	ORK_TAWER(Region.MIRKWOOD, LOTRFaction.DOL_GULDUR, 1355, 646),
    TOL_FUIN(Region.OCEAN, LOTRFaction.UNALIGNED, 357, 542),
    MENELTARMA_SUMMIT(Region.MENELTARMA, LOTRFaction.UNALIGNED, 5000, 4500, true),
    ...
    FORSAKEN_INN(Region.ERIADOR, LOTRFaction.UNALIGNED, 950, 743),
    BREE(Region.BREE_LAND, LOTRFaction.UNALIGNED, 917, 734),
    STADDLE(Region.BREE_LAND, LOTRFaction.UNALIGNED, 923, 736),
    COMBE(Region.BREE_LAND, LOTRFaction.UNALIGNED, 927, 731),
    ARCHET(Region.BREE_LAND, LOTRFaction.UNALIGNED, 929, 726),
    ...
    ISENGARD(Region.NAN_CURUNIR, LOTRFaction.URUK_HAI, 1102, 1058),
    ...
    EREBOR(Region.DALE, LOTRFaction.DWARF, 1463, 609),
    ...
    NIMRODEL(Region.LOTHLORIEN, LOTRFaction.GALADHRIM, 1198, 894),
    ...
    Kararun(Region.RHUN, LOTRFaction.UNALIGNED, 2364, 1320),
    Sarzaran(Region.RHUN, LOTRFaction.UNALIGNED, 2100, 1210),
    Chulzanar(Region.RHUN, LOTRFaction.UNALIGNED, 2415, 1478),
    
    
    
    RHUN_ROAD_WAY(Region.RHUN, LOTRFaction.UNALIGNED, 2228, 835),
    BALCARAS(Region.RHUN, LOTRFaction.UNALIGNED, 2231, 1058),
    KHAND_NORTH_ROAD(Region.RHUN, LOTRFaction.KHAND, 1932, 1331),
    RHUN_CAPITAL(Region.RHUN_KHAGANATE, LOTRFaction.RHUN, 1867, 984),
    KHAMUL_TOWER(Region.RHUN_KHAGANATE, LOTRFaction.RHUN, 1888, 878),
    MORDOR_FORD(Region.RHUN_KHAGANATE, LOTRFaction.RHUN, 1834, 1112),
    RHUN_NORTH_CITY(Region.RHUN_KHAGANATE, LOTRFaction.RHUN, 1903, 914),
    BAZYLAN(Region.RHUN_KHAGANATE, LOTRFaction.RHUN, 1921, 889),
    BORDER_TOWN(Region.RHUN_KHAGANATE, LOTRFaction.RHUN, 1794, 979),
    RHUN_SEA_CITY(Region.RHUN_KHAGANATE, LOTRFaction.RHUN, 1837, 956),
    ...
    RHUN_SOUTH_PASS(Region.RHUN_KHAGANATE, LOTRFaction.RHUN, 1869, 1055),
    RHUN_EAST_CITY(Region.RHUN_KHAGANATE, LOTRFaction.RHUN, 2010, 962),
    RHUN_EAST_TOWN(Region.RHUN_KHAGANATE, LOTRFaction.RHUN, 1983, 936),
    ...
    KHAND_FORD(Region.LOSTLADEN, LOTRFaction.KHAND, 1778, 1432),
    ...
    JUNGLE_CITY_NORTH(Region.FAR_HARAD_JUNGLE, LOTRFaction.TAUREDAIN, 1419, 2604),
    JUNGLE_CITY_EAST(Region.FAR_HARAD_JUNGLE, LOTRFaction.TAUREDAIN, 1594, 2766),
    JUNGLE_CITY_CAPITAL(Region.FAR_HARAD_JUNGLE, LOTRFaction.TAUREDAIN, 1380, 2861),
    JUNGLE_CITY_DEEP(Region.FAR_HARAD_JUNGLE, LOTRFaction.UNALIGNED, 1180, 3206),
    JUNGLE_CITY_WATCH(Region.FAR_HARAD_JUNGLE, LOTRFaction.UNALIGNED, 1590, 2940),
    JUNGLE_CITY_CAVES(Region.FAR_HARAD_JUNGLE, LOTRFaction.TAUREDAIN, 1257, 3054),
    JUNGLE_CITY_STONE(Region.FAR_HARAD_JUNGLE, LOTRFaction.TAUREDAIN, 1236, 2787),
    ...
    Eldanor(Region.LONE_LANDS, LOTRFaction.ANGMAR, 1033, 626),
    Buurz_Zegx(Region.NAN_CURUNIR, LOTRFaction.URUK_HAI, 1097, 1065),
    Oplot_Rydaur(Region.ANGMAR, LOTRFaction.ANGMAR, 1051, 550);
    ...
    private LOTRWaypoint(Region r, LOTRFaction f, int x, int y) {
        this(r, f, x, y, false);
    }

    private LOTRWaypoint(Region r, LOTRFaction f, int x, int y, boolean hide) {
        this.region = r;
    ...
    public boolean hasPlayerUnlocked(EntityPlayer entityplayer) {
        return this.isUnlockable(entityplayer) && LOTRLevelData.getData(entityplayer).isFTRegionUnlocked(this.region);
    }

    @Override
    public boolean isUnlockable(EntityPlayer entityplayer) {
        return this.faction == LOTRFaction.UNALIGNED || LOTRLevelData.getData(entityplayer).getAlignment(this.faction) >= 0.0f;
    }

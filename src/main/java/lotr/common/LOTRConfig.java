...
public class LOTRConfig {
    ...
    public static void load() {
        ...
        newRain = config.get(CATEGORY_ENVIRONMENT, "New rain", true, "New rain sounds and mist during rain").getBoolean();
    ...
    static {
        ...
        CATEGORY_DIMENSION = LOTRConfig.getCategory("dimension");
        CATEGORY_GAMEPLAY = LOTRConfig.getCategory("gameplay");
        CATEGORY_GUI = LOTRConfig.getCategory("gui");
        CATEGORY_ENVIRONMENT = LOTRConfig.getCategory("environment");
        CATEGORY_MISC = LOTRConfig.getCategory("misc");
    }
}

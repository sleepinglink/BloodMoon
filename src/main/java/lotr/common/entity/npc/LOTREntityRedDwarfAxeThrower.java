...
public class LOTREntityRedDwarfAxeThrower extends LOTREntityRedDwarfWarrior{
	public LOTREntityRedDwarfAxeThrower(World world) {
        super(world);
    }
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        this.npcItemsInv.setRangedWeapon(new ItemStack(LOTRMod.throwing_axe_red_dwarven));
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase target, float f) {
        ...
        if(axeItem == null) {
            axeItem = new ItemStack(LOTRMod.throwing_axe_red_dwarven);
        }

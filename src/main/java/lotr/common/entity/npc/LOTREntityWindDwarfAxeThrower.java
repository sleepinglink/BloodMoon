...
public class LOTREntityWindDwarfAxeThrower extends LOTREntityWindDwarfWarrior{
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        this.npcItemsInv.setRangedWeapon(new ItemStack(LOTRMod.throwing_axe_wind_dwarven));
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase target, float f) {
        ...
        if(axeItem == null) {
            axeItem = new ItemStack(LOTRMod.throwing_axe_wind_dwarven);
        }

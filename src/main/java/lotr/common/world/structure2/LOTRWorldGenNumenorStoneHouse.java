...
public class LOTRWorldGenNumenorStoneHouse extends LOTRWorldGenNumenorStructure {
    public LOTRWorldGenNumenorStoneHouse(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        if(random.nextInt(4) == 0) {
            this.placeChest(world, random, 0, 0, 1, LOTRMod.chestLebethron, 2, LOTRChestContents2.NUMENOR_HOUSE_TREASURE);
        }
        ...
        this.placeChest(world, random, 3, 1, -1, 5, LOTRChestContents2.NUMENOR_HOUSE);
        ...
        this.placeChest(world, random, -3, 5, -3, 4, LOTRChestContents2.NUMENOR_HOUSE);
        ...
        this.placeChest(world, random, -3, 5, 4, 4, LOTRChestContents2.NUMENOR_HOUSE);
        ...
        int men = 2;
        for(int l = 0; l < men; ++l) {
            LOTREntityNumenor gondorMan = new LOTREntityNumenor(world);

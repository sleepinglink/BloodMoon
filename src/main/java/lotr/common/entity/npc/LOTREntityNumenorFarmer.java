...
public class LOTREntityNumenorFarmer extends LOTREntityNumenor implements LOTRTradeable, LOTRUnitTradeable {
    public LOTREntityNumenorFarmer(World world) {
        super(world);
    ...
    public void onPlayerTrade(EntityPlayer entityplayer, LOTRTradeEntries.TradeType type, ItemStack itemstack) {
        if(type == LOTRTradeEntries.TradeType.BUY && itemstack.getItem() == Item.getItemFromBlock(LOTRMod.pipeweedPlant)) {
            LOTRLevelData.getData(entityplayer).addAchievement(LOTRAchievement.buyPipeweedNumenorFarmer);
        }
    }

    @Override
    public LOTRUnitTradeEntries getUnits() {
        return LOTRUnitTradeEntries.NUMENOR_FARMER;
    }

    @Override
    public void onUnitTrade(EntityPlayer entityplayer) {
        LOTRLevelData.getData(entityplayer).addAchievement(LOTRAchievement.hireNumenorFarmer);
    }

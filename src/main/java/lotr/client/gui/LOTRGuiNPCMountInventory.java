...
public class LOTRGuiNPCMountInventory extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int i, int j) {
        this.fontRendererObj.drawString(this.theMountInv.hasCustomInventoryName() ? this.theMountInv.getInventoryName() : I18n.format(this.theMountInv.getInventoryName(), new Object[0]), 8, 6, 4210752);
        this.fontRendererObj.drawString(this.thePlayerInv.hasCustomInventoryName() ? this.thePlayerInv.getInventoryName() : I18n.format(this.thePlayerInv.getInventoryName(), new Object[0]), 8, this.ySize - 96 + 2, 4210752);
    }

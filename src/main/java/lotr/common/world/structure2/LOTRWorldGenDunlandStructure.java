...
public abstract class LOTRWorldGenDunlandStructure extends LOTRWorldGenStructureBase2 {
    ...
    protected ItemStack getRandomDunlandWeapon(Random random) {
        ItemStack[] items = new ItemStack[] {new ItemStack(Items.iron_sword), new ItemStack(LOTRMod.spearIron), new ItemStack(LOTRMod.daggerIron), new ItemStack(Items.stone_sword), new ItemStack(LOTRMod.spearStone),  new ItemStack(LOTRMod.dunlendingTrident)};

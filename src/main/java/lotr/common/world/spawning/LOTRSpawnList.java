...
public class LOTRSpawnList {
    public static final LOTRSpawnList HOBBITS = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityHobbit.class, 40, 1, 4), new LOTRSpawnEntry(LOTREntityHobbitShirriff.class, 1, 1, 3));
    ...
    public static final LOTRSpawnList URUK_DG = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityUruk_dg.class, 20, 2, 4));
    ...
    public static final LOTRSpawnList Uruk_dg = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityUruk_dg.class, 20, 4, 6));
    ...
    public static final LOTRSpawnList KHAND = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityKhand.class, 20, 2, 4));
    public static final LOTRSpawnList KHAND_SOLDIER = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityKhandSoldier.class, 20, 2, 4));
    public static final LOTRSpawnList KHAND_ARCHER = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityKhandArcher.class, 20, 2, 4));
    
    public static final LOTRSpawnList RED_MOUNTAIN = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityRedDwarf.class, 20, 2, 4));
    public static final LOTRSpawnList RED_MOUNTAIN_WARRIOR = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityRedDwarfWarrior.class, 20, 2, 4));
    public static final LOTRSpawnList RED_MOUNTAIN_AXE_THROWER = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityRedDwarfAxeThrower.class, 20, 2, 4));
    
    public static final LOTRSpawnList WIND_MOUNTAIN  = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityWindDwarf.class, 20, 2, 4));
    public static final LOTRSpawnList WIND_MOUNTAIN_WARRIOR  = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityWindDwarfWarrior.class, 20, 2, 4));
    public static final LOTRSpawnList WIND_MOUNTAIN_AXE_THROWER  = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityWindDwarfAxeThrower.class, 20, 2, 4));
    
    public static final LOTRSpawnList NUMENOR = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityNumenor.class, 20, 2, 4));
    public static final LOTRSpawnList NUMENOR_SOLDIER = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityNumenorLevyman.class, 20, 2, 4), new LOTRSpawnEntry(LOTREntityNumenorSoldier.class, 20, 2, 4));
    public static final LOTRSpawnList NUMENOR_ARCHER = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityNumenorArcher.class, 20, 2, 4));
    
    public static final LOTRSpawnList DARK_WOOD = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityDarkWoodElf.class, 10, 4, 6));
    public static final LOTRSpawnList DARK_WOOD_SOLDIER = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityDarkWoodSoldierElf.class, 20, 2, 4));
    
    public static final LOTRSpawnList GONDOR_RENEGADE = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityGondorRenegade.class, 20, 3, 6));

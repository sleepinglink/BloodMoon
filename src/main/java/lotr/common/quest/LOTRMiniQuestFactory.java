...
public enum LOTRMiniQuestFactory {
	WIND_MOUNTAINS("windMountains"),
	RED_MOUNTAINS("redMountains"),
	DARK_WOOD("darkwood"),
	NUMENOR("numenor"),
    HOBBIT("hobbit"),
    ...
    private Map<Class<? extends LOTRMiniQuest>, List<LOTRMiniQuest.QuestFactoryBase>> questFactories = new HashMap<Class<? extends LOTRMiniQuest>, List<LOTRMiniQuest.QuestFactoryBase>>();
    private LOTRAchievement questAchievement;
    private List<LOTRLore.LoreCategory> loreCategories = new ArrayList<LOTRLore.LoreCategory>();
    ...
    private void addQuest(LOTRMiniQuest.QuestFactoryBase factory) {
        ...
        if(list == null) {
            list = new ArrayList<LOTRMiniQuest.QuestFactoryBase>();
    ...
    public LOTRMiniQuest createQuest(LOTREntityNPC npc) {
        ...
        if(totalWeight <= 0) {
            FMLLog.warning("LOTR: No quests registered for %s!", this.baseName);
            return null;
        }
        int i = randomWeight = rand.nextInt(totalWeight);
        Iterator<Map.Entry<Class<? extends LOTRMiniQuest>, List<LOTRMiniQuest.QuestFactoryBase>>> iterator = this.questFactories.entrySet().iterator();
        ...
        while(iterator.hasNext()) {
            ...
            if((i -= LOTRMiniQuestFactory.getQuestClassWeight(next.getKey())) >= 0) continue;
        }
    ...
    private static int getTotalQuestClassWeight(LOTRMiniQuestFactory factory) {
        HashSet<Class<? extends LOTRMiniQuest>> registeredQuestTypes = new HashSet<Class<? extends LOTRMiniQuest>>();
    ...
    public static void createMiniQuests() {
        ...
        RED_MOUNTAINS.setAchievement(LOTRAchievement.doMiniquestRedMountains);
        RED_MOUNTAINS.setLore(LOTRLore.LoreCategory.RED_MOUNTAINS);
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("mineMithril").setCollectItem(new ItemStack(LOTRMod.mithril), 1, 2).setRewardFactor(50.0f));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(Items.gold_ingot), 3, 15).setRewardFactor(4.0f));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(LOTRMod.silver), 3, 15).setRewardFactor(4.0f));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(Items.glowstone_dust), 5, 15).setRewardFactor(2.0f));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(LOTRMod.diamond), 1, 3).setRewardFactor(15.0f));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(LOTRMod.sapphire), 1, 3).setRewardFactor(12.0f));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(LOTRMod.opal), 1, 3).setRewardFactor(10.0f));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(LOTRMod.amethyst), 1, 3).setRewardFactor(10.0f));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("forgeDwarfWeapon").setCollectItem(new ItemStack(LOTRMod.hammer_red_dwarven), 1, 3).setRewardFactor(5.0f));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("forgeDwarfWeapon").setCollectItem(new ItemStack(LOTRMod.battleaxe_red_dwarven), 1, 3).setRewardFactor(5.0f));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("forgeDwarfWeapon").setCollectItem(new ItemStack(LOTRMod.throwing_axe_red_dwarven), 1, 4).setRewardFactor(4.0f));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectDrink").setCollectItem(new ItemStack(LOTRMod.mugDwarvenAle), 2, 5).setRewardFactor(3.0f));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.GALADHRIM, 10, 40));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.DORWINION, 10, 40));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.WOOD_ELF, 10, 40));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.DALE, 10, 40));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killElf").setKillEntity(LOTREntityGaladhrimElf.class, 10, 30));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killElf").setKillEntity(LOTREntityWoodElf.class, 10, 30));
        RED_MOUNTAINS.addQuest(new LOTRMiniQuestBounty.QFBounty("bounty"));
        
        WIND_MOUNTAINS.setAchievement(LOTRAchievement.doMiniquestWindMountains);
        WIND_MOUNTAINS.setLore(LOTRLore.LoreCategory.WIND_MOUNTAINS);
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("mineMithril").setCollectItem(new ItemStack(LOTRMod.mithril), 1, 2).setRewardFactor(50.0f));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(Items.gold_ingot), 3, 15).setRewardFactor(4.0f));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(LOTRMod.silver), 3, 15).setRewardFactor(4.0f));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(Items.glowstone_dust), 5, 15).setRewardFactor(2.0f));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(LOTRMod.diamond), 1, 3).setRewardFactor(15.0f));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(LOTRMod.sapphire), 1, 3).setRewardFactor(12.0f));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(LOTRMod.opal), 1, 3).setRewardFactor(10.0f));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMineral").setCollectItem(new ItemStack(LOTRMod.amethyst), 1, 3).setRewardFactor(10.0f));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("forgeDwarfWeapon").setCollectItem(new ItemStack(LOTRMod.hammer_wind_dwarven), 1, 3).setRewardFactor(5.0f));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("forgeDwarfWeapon").setCollectItem(new ItemStack(LOTRMod.battleaxe_wind_dwarven), 1, 3).setRewardFactor(5.0f));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("forgeDwarfWeapon").setCollectItem(new ItemStack(LOTRMod.throwing_axe_wind_dwarven), 1, 4).setRewardFactor(4.0f));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestCollect.QFCollect("collectDrink").setCollectItem(new ItemStack(LOTRMod.mugDwarvenAle), 2, 5).setRewardFactor(3.0f));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.GALADHRIM, 10, 40));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.DORWINION, 10, 40));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.WOOD_ELF, 10, 40));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.DALE, 10, 40));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killElf").setKillEntity(LOTREntityGaladhrimElf.class, 10, 30));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killElf").setKillEntity(LOTREntityWoodElf.class, 10, 30));
        WIND_MOUNTAINS.addQuest(new LOTRMiniQuestBounty.QFBounty("bounty"));
        ...
        GUNDABAD.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.GALADHRIM, 10, 40));
        ...
        DARK_WOOD.setAchievement(LOTRAchievement.doMiniquestDarkWood);
        DARK_WOOD.setLore(LOTRLore.LoreCategory.DARK_WOOD);
        DARK_WOOD.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.swordDarkwood), 1, 4).setRewardFactor(3.0f));
        DARK_WOOD.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.polearmDarkwood), 1, 4).setRewardFactor(3.0f));
        DARK_WOOD.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.pikeDarkwood), 1, 4).setRewardFactor(3.0f));
        DARK_WOOD.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.spearDarkwood), 1, 4).setRewardFactor(2.0f));
        DARK_WOOD.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.helmet_darkwood), 1, 4).setRewardFactor(3.0f));
        DARK_WOOD.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.body_darkwood), 1, 4).setRewardFactor(4.0f));
        DARK_WOOD.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.legs_darkwood), 1, 4).setRewardFactor(3.0f));
        DARK_WOOD.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.boots_darkwood), 1, 4).setRewardFactor(4.0f));
        DARK_WOOD.addQuest(new LOTRMiniQuestCollect.QFCollect("collectString").setCollectItem(new ItemStack(Items.string), 5, 20).setRewardFactor(1.0f));
        DARK_WOOD.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killThings").setKillEntity(LOTREntityGondorMan.class, 10, 30));
        DARK_WOOD.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killThings").setKillEntity(LOTREntityRangerIthilien.class, 10, 30));
        DARK_WOOD.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killThings").setKillEntity(LOTREntityDaleMan.class, 10, 30));
        DARK_WOOD.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killThings").setKillEntity(LOTREntityRabbit.class, 10, 30));
        DARK_WOOD.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killThings").setKillEntity(LOTREntityDeer.class, 10, 30));
        DARK_WOOD.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killGondorAllies").setKillEntity(LOTREntityRohirrimWarrior.class, 10, 30));
        DARK_WOOD.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killGondorAllies").setKillEntity(LOTREntityDaleSoldier.class, 10, 30));
        DARK_WOOD.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killGondorAllies").setKillEntity(LOTREntityDolAmrothSoldier.class, 10, 30));
        DARK_WOOD.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killGondorAllies").setKillEntity(LOTREntityLossarnachAxeman.class, 10, 30));
        DARK_WOOD.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killDale").setKillFaction(LOTRFaction.DALE, 20, 40));
        DARK_WOOD.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killNorthmen").setKillFaction(LOTRFaction.DALE, 10, 40));
        DARK_WOOD.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killDwarves").setKillFaction(LOTRFaction.DWARF, 10, 40));
        DARK_WOOD.addQuest(new LOTRMiniQuestBounty.QFBounty("bounty"));
        ...
        DOL_GULDUR.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.GALADHRIM, 10, 40));
        ...
        ROHAN_SHIELDMAIDEN.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemies").setKillFaction(LOTRFaction.URUK_HAI, 5, 20));
        ...
        NUMENOR.setAchievement(LOTRAchievement.doMiniquestNumenor);
        NUMENOR.setLore(LOTRLore.LoreCategory.NUMENOR);
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("defences").setCollectItem(new ItemStack(Blocks.log, 1, 0), 20, 60).setRewardFactor(0.25f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("defences").setCollectItem(new ItemStack(Blocks.planks, 1, 0), 80, 160).setRewardFactor(0.125f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("defences").setCollectItem(new ItemStack(LOTRMod.rock, 1, 1), 30, 80).setRewardFactor(0.25f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("defences").setCollectItem(new ItemStack(LOTRMod.brick, 1, 1), 30, 60).setRewardFactor(0.5f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("defences").setCollectItem(new ItemStack(LOTRMod.brick5, 1, 8), 30, 60).setRewardFactor(0.5f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("lebethron").setCollectItem(new ItemStack(LOTRMod.wood2, 1, 0), 10, 30).setRewardFactor(1.0f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectIron").setCollectItem(new ItemStack(Blocks.iron_ore), 10, 20).setRewardFactor(1.0f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectIron").setCollectItem(new ItemStack(Items.iron_ingot), 6, 15).setRewardFactor(1.5f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("blackMarble").setCollectItem(new ItemStack(LOTRMod.rock, 1, 0), 25, 35).setRewardFactor(1.0f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.swordNumenor), 1, 4).setRewardFactor(5.0f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.spearNumenor), 1, 4).setRewardFactor(5.0f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.pikeNumenor), 1, 4).setRewardFactor(5.0f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.helmetNumenor), 1, 4).setRewardFactor(5.0f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.bodyNumenor), 1, 4).setRewardFactor(5.0f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.legsNumenor), 1, 4).setRewardFactor(5.0f));
        NUMENOR.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.bootsNumenor), 1, 4).setRewardFactor(5.0f));
        NUMENOR.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killMordor").setKillFaction(LOTRFaction.MORDOR, 10, 40));
        NUMENOR.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.MORDOR, 30, 40));
        NUMENOR.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.DUNLAND, 30, 40));
        NUMENOR.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.URUK_HAI, 30, 40));
        NUMENOR.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killMordorMany").setKillFaction(LOTRFaction.MORDOR, 60, 90));
        NUMENOR.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killHarad").setKillFaction(LOTRFaction.NEAR_HARAD, 10, 40));
        NUMENOR.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killHarnedor").setKillEntity(LOTREntityHarnedorWarrior.class, 20, 30));
        NUMENOR.addQuest(new LOTRMiniQuestBounty.QFBounty("bounty"));
        ...
        GONDOR.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killEnemy").setKillFaction(LOTRFaction.URUK_HAI, 30, 40));
        ...
        GONDOR.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killHarnedor").setKillEntity(LOTREntityHarnedorWarrior.class, 20, 30));
        ...
        KHAND.setAchievement(LOTRAchievement.doMiniquestKhand);
        KHAND.setLore(LOTRLore.LoreCategory.KHAND);
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.swordKhand), 1, 4).setRewardFactor(3.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.spearKhand), 1, 4).setRewardFactor(3.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.pikeKhand), 1, 4).setRewardFactor(3.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("forge").setCollectItem(new ItemStack(LOTRMod.battleaxeKhand), 1, 4).setRewardFactor(3.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectOrcItem").setCollectItem(new ItemStack(LOTRMod.helmetkhand), 2, 4).setRewardFactor(4.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectOrcItem").setCollectItem(new ItemStack(LOTRMod.bodykhand), 2, 4).setRewardFactor(4.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectOrcItem").setCollectItem(new ItemStack(LOTRMod.legskhand), 2, 4).setRewardFactor(4.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectOrcItem").setCollectItem(new ItemStack(LOTRMod.bootskhand), 2, 4).setRewardFactor(4.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("goHunting").setCollectItem(new ItemStack(LOTRMod.rabbitRaw), 5, 10).setRewardFactor(2.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("goHunting").setCollectItem(new ItemStack(LOTRMod.deerRaw), 5, 10).setRewardFactor(2.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("goHunting").setCollectItem(new ItemStack(Items.beef), 5, 10).setRewardFactor(2.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectFire").setCollectItem(new ItemStack(LOTRMod.nauriteGem), 4, 8).setRewardFactor(3.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectFire").setCollectItem(new ItemStack(LOTRMod.sulfur), 4, 8).setRewardFactor(2.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectFire").setCollectItem(new ItemStack(LOTRMod.saltpeter), 4, 8).setRewardFactor(2.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectRations").setCollectItem(new ItemStack(Items.bread), 5, 8).setRewardFactor(2.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectRations").setCollectItem(new ItemStack(LOTRMod.oliveBread), 5, 8).setRewardFactor(2.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectRations").setCollectItem(new ItemStack(Items.cooked_beef), 2, 8).setRewardFactor(2.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectRations").setCollectItem(new ItemStack(Items.cooked_fished), 2, 8).setRewardFactor(2.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectRations").setCollectItem(new ItemStack(LOTRMod.muttonCooked), 2, 8).setRewardFactor(2.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectRations").setCollectItem(new ItemStack(LOTRMod.deerCooked), 2, 8).setRewardFactor(2.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectDorwinionWine").setCollectItem(new ItemStack(LOTRMod.mugRedWine), 3, 8).setRewardFactor(3.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("collectDorwinionWine").setCollectItem(new ItemStack(LOTRMod.mugWhiteWine), 3, 8).setRewardFactor(3.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("bringPoison").setCollectItem(new ItemStack(LOTRMod.bottlePoison), 2, 4).setRewardFactor(5.0f));
        KHAND.addQuest(new LOTRMiniQuestCollect.QFCollect("bringPoison").setCollectItem(new ItemStack(LOTRMod.sulfur), 4, 8).setRewardFactor(2.0f));
        KHAND.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killThings").setKillEntity(LOTREntityGondorMan.class, 10, 30));
        KHAND.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killThings").setKillEntity(LOTREntityRangerIthilien.class, 10, 30));
        KHAND.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killThings").setKillEntity(LOTREntityDaleMan.class, 10, 30));
        KHAND.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killThings").setKillEntity(LOTREntityRabbit.class, 10, 30));
        KHAND.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killThings").setKillEntity(LOTREntityDeer.class, 10, 30));
        KHAND.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killGondorAllies").setKillEntity(LOTREntityRohirrimWarrior.class, 10, 30));
        KHAND.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killGondorAllies").setKillEntity(LOTREntityDaleSoldier.class, 10, 30));
        KHAND.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killGondorAllies").setKillEntity(LOTREntityDolAmrothSoldier.class, 10, 30));
        KHAND.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killGondorAllies").setKillEntity(LOTREntityLossarnachAxeman.class, 10, 30));
        KHAND.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("conquerGondor").setKillFaction(LOTRFaction.GONDOR, 20, 50));
        KHAND.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killGondor").setKillFaction(LOTRFaction.GONDOR, 20, 50));
        KHAND.addQuest(new LOTRMiniQuestBounty.QFBounty("bounty"));
        ...
        RHUN.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killDwarves").setKillFaction(LOTRFaction.DWARF, 10, 40));
        RHUN.addQuest(new LOTRMiniQuestBounty.QFBounty("bounty"));
        
        HARNEDOR.setAchievement(LOTRAchievement.doMiniquestNearHarad);
        HARNEDOR.setLore(LOTRLore.LoreCategory.HARNEDOR);
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("bringWater").setCollectItem(new ItemStack(Items.water_bucket), 3, 5).setRewardFactor(5.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectBlackRock").setCollectItem(new ItemStack(LOTRMod.rock, 1, 0), 30, 50).setRewardFactor(0.5f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectDates").setCollectItem(new ItemStack(LOTRMod.date), 8, 15).setRewardFactor(2.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectFruit").setCollectItem(new ItemStack(LOTRMod.lemon), 4, 12).setRewardFactor(2.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectFruit").setCollectItem(new ItemStack(LOTRMod.orange), 4, 12).setRewardFactor(2.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectFruit").setCollectItem(new ItemStack(LOTRMod.lime), 4, 12).setRewardFactor(2.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectFruit").setCollectItem(new ItemStack(LOTRMod.plum), 4, 12).setRewardFactor(2.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("orangeJuice").setCollectItem(new ItemStack(LOTRMod.mugOrangeJuice), 2, 6).setRewardFactor(4.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("lemonLiqueur").setCollectItem(new ItemStack(LOTRMod.mugLemonLiqueur), 2, 6).setRewardFactor(4.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectPoison").setCollectItem(new ItemStack(LOTRMod.bottlePoison), 2, 4).setRewardFactor(5.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectRangedWeapon").setCollectItem(new ItemStack(LOTRMod.nearHaradBow), 1, 3).setRewardFactor(5.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectRangedWeapon").setCollectItem(new ItemStack(Items.arrow), 20, 40).setRewardFactor(0.5f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectTradeGoods").setCollectItem(new ItemStack(Items.dye, 1, 4), 3, 8).setRewardFactor(3.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectTradeGoods").setCollectItem(new ItemStack(LOTRMod.lionFur), 3, 6).setRewardFactor(3.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectTradeGoods").setCollectItem(new ItemStack(LOTRMod.doubleFlower, 1, 3), 5, 15).setRewardFactor(1.5f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectTradeGoods").setCollectItem(new ItemStack(LOTRMod.olive), 10, 20).setRewardFactor(1.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMarketFood").setCollectItem(new ItemStack(Items.bread), 5, 8).setRewardFactor(2.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMarketFood").setCollectItem(new ItemStack(LOTRMod.rabbitCooked), 5, 12).setRewardFactor(1.5f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMarketFood").setCollectItem(new ItemStack(LOTRMod.deerCooked), 5, 12).setRewardFactor(1.5f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMarketFood").setCollectItem(new ItemStack(LOTRMod.orange), 4, 8).setRewardFactor(2.5f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("collectMarketFood").setCollectItem(new ItemStack(LOTRMod.lemon), 4, 8).setRewardFactor(2.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("buildMaterials").setCollectItem(new ItemStack(Blocks.log, 1, 0), 20, 60).setRewardFactor(0.25f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("buildMaterials").setCollectItem(new ItemStack(LOTRMod.wood4, 1, 2), 20, 60).setRewardFactor(0.25f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("buildMaterials").setCollectItem(new ItemStack(Blocks.planks, 1, 0), 80, 160).setRewardFactor(0.125f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("buildMaterials").setCollectItem(new ItemStack(LOTRMod.planks2, 1, 2), 80, 160).setRewardFactor(0.125f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("buildMaterials").setCollectItem(new ItemStack(Blocks.sandstone, 1, 0), 30, 80).setRewardFactor(0.25f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("buildMaterials").setCollectItem(new ItemStack(Blocks.sandstone, 1, 1), 15, 40).setRewardFactor(0.5f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("buildMaterials").setCollectItem(new ItemStack(LOTRMod.thatch, 1, 1), 20, 40).setRewardFactor(0.5f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("specialFood").setCollectItem(new ItemStack(LOTRMod.orange), 4, 8).setRewardFactor(2.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("specialFood").setCollectItem(new ItemStack(LOTRMod.lemon), 4, 8).setRewardFactor(2.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("specialFood").setCollectItem(new ItemStack(LOTRMod.mango), 2, 4).setRewardFactor(4.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("specialFood").setCollectItem(new ItemStack(LOTRMod.banana), 2, 4).setRewardFactor(4.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestCollect.QFCollect("specialFood").setCollectItem(new ItemStack(LOTRMod.lionCooked), 3, 6).setRewardFactor(3.0f));
        HARNEDOR.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("conquerGondor").setKillFaction(LOTRFaction.GONDOR, 20, 50));
        HARNEDOR.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killGondor").setKillFaction(LOTRFaction.GONDOR, 20, 50));
        HARNEDOR.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("avengeRangers").setKillEntity(LOTREntityRangerIthilien.class, 10, 30));
        HARNEDOR.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killGondorSoldier").setKillEntity(LOTREntityGondorSoldier.class, 10, 30));
        HARNEDOR.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("reclaimHarondor").setKillEntity(LOTREntityGondorSoldier.class, 10, 30));
        HARNEDOR.addQuest(new LOTRMiniQuestKillEntity.QFKillEntity("killRohirrim").setKillEntity(LOTREntityRohirrimWarrior.class, 10, 30));
        HARNEDOR.addQuest(new LOTRMiniQuestBounty.QFBounty("bounty"));
        ...
        CORSAIR.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killTaurethrim").setKillFaction(LOTRFaction.TAUREDAIN, 10, 30));
        ...
        GULF_HARAD.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killTaurethrim").setKillFaction(LOTRFaction.TAUREDAIN, 10, 30));
        ...
        MOREDAIN.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killTauredain").setKillFaction(LOTRFaction.TAUREDAIN, 20, 50));
        ...
        TAUREDAIN.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killMoredain").setKillFaction(LOTRFaction.MOREDAIN, 20, 50));
        ...
        HALF_TROLL.addQuest(new LOTRMiniQuestKillFaction.QFKillFaction("killTauredain").setKillFaction(LOTRFaction.TAUREDAIN, 20, 50));
    ...
    static {
        rand = new Random();
        questClassWeights = new HashMap<Class<? extends LOTRMiniQuest>, Integer>();
    }
}

...
public abstract class LOTRWorldGenKhandStructure extends LOTRWorldGenStructureBase2 {
    protected Block brickBlock;
    protected int brickMeta;
	protected Block bbrickBlock;
    protected int bbrickMeta;
    ...
    public LOTRWorldGenKhandStructure(boolean flag) {
        super(flag);
    }
    ...
    protected void setupRandomBlocks(Random random) {
        this.bbrickBlock = LOTRMod.brick7;
        this.bbrickMeta = 0;

...
public class LOTRWorldGenNumenorWatchtower extends LOTRWorldGenNumenorStructure {
    public  LOTRWorldGenNumenorWatchtower(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        this.placeChest(world, random, -2, 7, -2, LOTRMod.chestLebethron, 4, LOTRChestContents2.NUMENOR_FORTRESS_SUPPLIES);
        ...
        LOTREntityNumenor soldier = (LOTREntityNumenor) LOTREntities.createEntityByClass(levyClasses[0], world);
        soldier.spawnRidingHorse = false;
        this.spawnNPCAndSetHome(soldier, world, 0, 7, 0, 16);
        soldier = (LOTREntityNumenor) LOTREntities.createEntityByClass(levyClasses[0], world);
        soldier.spawnRidingHorse = false;
        ...
        for(int l = 0; l < levymen; ++l) {
            ...
            LOTREntityNumenor levyman = (LOTREntityNumenor) LOTREntities.createEntityByClass(entityClass, world);

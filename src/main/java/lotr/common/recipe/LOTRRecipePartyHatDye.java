...
public class LOTRRecipePartyHatDye implements IRecipe {
    ...
    public boolean matches(InventoryCrafting inv, World world) {
        ...
        for(int i = 0; i < inv.getSizeInventory(); ++i) {
            ...
            if(itemstack.getItem() == LOTRMod.partyHat) {
                if(hat != null) {
                    return false;
                }
                hat = itemstack;
    ...
    public ItemStack getCraftingResult(InventoryCrafting inv) {
        ...
        for(int i = 0; i < inv.getSizeInventory(); ++i) {
            ...
            if(itemstack.getItem() == LOTRMod.partyHat) {
                ...
                hat = itemstack.copy();
                hat.stackSize = 1;
                if(!LOTRItemPartyHat.isHatDyed(hat)) continue;
                int hatColor = LOTRItemPartyHat.getHatColor(hat);
        ...
        LOTRItemPartyHat.setHatColor(hat, color);
        return hat;
    }

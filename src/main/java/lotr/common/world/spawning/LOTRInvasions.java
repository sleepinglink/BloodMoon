...
public enum LOTRInvasions {
    ...
    public static void createMobLists() {
        ...
        LOTRInvasions.HOBBIT.invasionMobs.add(new InvasionSpawnEntry(LOTREntityHobbitShirriff.class, 15));
        ...
        LOTRInvasions.DOL_GULDUR.invasionMobs.add(new InvasionSpawnEntry(LOTREntityUruk_dg.class, 5));
        ...
        LOTRInvasions.DUNLAND.invasionIcon = LOTRMod.swordDunland;
        ...
        LOTRInvasions.KHAND.invasionIcon = LOTRMod.swordKhand; 
        LOTRInvasions.KHAND.invasionMobs.add(new InvasionSpawnEntry(LOTREntityKhandSoldier.class, 10));
        LOTRInvasions.KHAND.invasionMobs.add(new InvasionSpawnEntry(LOTREntityKhandArcher.class, 5));
        LOTRInvasions.KHAND.invasionMobs.add(new InvasionSpawnEntry(LOTREntityKhandBannerBearer.class, 5));
        LOTRInvasions.RED_MOUNTAINS.invasionIcon = LOTRMod.battleaxe_red_dwarven;
        LOTRInvasions.RED_MOUNTAINS.invasionMobs.add(new InvasionSpawnEntry(LOTREntityRedDwarfWarrior.class, 10));
        LOTRInvasions.RED_MOUNTAINS.invasionMobs.add(new InvasionSpawnEntry(LOTREntityRedDwarfAxeThrower.class, 5));
        LOTRInvasions.RED_MOUNTAINS.invasionMobs.add(new InvasionSpawnEntry(LOTREntityRedDwarfBannerBearer.class, 5));
        LOTRInvasions.WIND_MOUNTAINS.invasionIcon = LOTRMod.hammer_wind_dwarven;
        LOTRInvasions.WIND_MOUNTAINS.invasionMobs.add(new InvasionSpawnEntry(LOTREntityWindDwarfWarrior.class, 10));
        LOTRInvasions.WIND_MOUNTAINS.invasionMobs.add(new InvasionSpawnEntry(LOTREntityWindDwarfAxeThrower.class, 5));
        LOTRInvasions.WIND_MOUNTAINS.invasionMobs.add(new InvasionSpawnEntry(LOTREntityWindDwarfBannerBearer.class, 5));
        LOTRInvasions.NUMENOR.invasionIcon = LOTRMod.hammerNumenor;
        LOTRInvasions.NUMENOR.invasionMobs.add(new InvasionSpawnEntry(LOTREntityNumenorSoldier.class, 10));
        LOTRInvasions.NUMENOR.invasionMobs.add(new InvasionSpawnEntry(LOTREntityNumenorArcher.class, 5));
        LOTRInvasions.NUMENOR.invasionMobs.add(new InvasionSpawnEntry(LOTREntityNumenorBannerBearer.class, 5));
        LOTRInvasions.DARK_WOOD.invasionIcon = LOTRMod.darkwoodBow;
        LOTRInvasions.DARK_WOOD.invasionMobs.add(new InvasionSpawnEntry(LOTREntityDarkWoodSoldierElf.class, 10));
        LOTRInvasions.DARK_WOOD.invasionMobs.add(new InvasionSpawnEntry(LOTREntityDarkWoodBannerBearer.class, 5));

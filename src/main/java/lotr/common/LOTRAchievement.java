...
public class LOTRAchievement {
    ...
    public static LOTRAchievement killNumenor;
    public static LOTRAchievement killUruk_dg;
    ...
    public static LOTRAchievement tradeDarkWoodElfCaptain;
    public static LOTRAchievement tradeNumenorCaptain;
    public static LOTRAchievement tradeKhandCaptain;
    ...
    public static LOTRAchievement doMiniquestDarkWood;
    public static LOTRAchievement doMiniquestNumenor;
    public static LOTRAchievement doMiniquestKhand;
    ...
    public static LOTRAchievement tradeNumenorBlacksmith;
    public static LOTRAchievement tradeKhandBlacksmith;
    public static LOTRAchievement tradeDarkWoodBlacksmith;
    
    
    public static LOTRAchievement tradeDaleBaker;
    public static LOTRAchievement tradeDaleMerchant;
    public static LOTRAchievement tradeNumenorMerchant;
    public static LOTRAchievement tradeKhandMerchant;
    public static LOTRAchievement tradeDarkWoodMerchant;
    ...
    public static LOTRAchievement tradeNumenorBartender;
    ...
    public static LOTRAchievement killKhanding;
    ...
    private static Map armorAchievements = new HashMap();
    ...
    public LOTRAchievement setRequiresEnemy(List<LOTRFaction> f) {
        return this.setRequiresEnemy(f.toArray(new LOTRFaction[0]));
    }
    ...
    public LOTRAchievement setRequiresAlly(List<LOTRFaction> f) {
        return this.setRequiresAlly(f.toArray(new LOTRFaction[0]));
    }
    ...
    public String getTitle(EntityPlayer entityplayer) {
        return StatCollector.translateToLocal(this.getUntranslatedTitle());
    }
    ...
    public static void createAchievements() {
        ...
        killOrc = new LOTRAchievement(Category.GENERAL, 14, LOTRMod.orcBone, "killOrc").setRequiresEnemy(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_ORC)).createTitle();
        mineMithril = new LOTRAchievement(Category.GENERAL, 15, LOTRMod.oreMithril, "mineMithril").createTitle();
        rideWarg = new LOTRAchievement(Category.GENERAL, 16, Items.saddle, "rideWarg").setRequiresAlly(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_ORC)).createTitle();
        killWarg = new LOTRAchievement(Category.GENERAL, 17, LOTRMod.wargBone, "killWarg").setRequiresEnemy(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_ORC)).createTitle();
        ...
        hitByOrcSpear = new LOTRAchievement(Category.GENERAL, 34, LOTRMod.spearOrc, "hitByOrcSpear").setRequiresEnemy(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_ORC));
        killBombardier = new LOTRAchievement(Category.GENERAL, 35, LOTRMod.orcBomb, "killBombardier").setRequiresEnemy(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_ORC));
        ...
        eatManFlesh = new LOTRAchievement(Category.GENERAL, 58, LOTRMod.manFlesh, "eatManFlesh").setRequiresAlly(LOTRItemManFlesh.getManFleshFactions()).createTitle("manFlesh");
        craftSaltedFlesh = new LOTRAchievement(Category.GENERAL, 59, LOTRMod.saltedFlesh, "craftSaltedFlesh").createTitle("saltedFlesh");
        enchantBaneElf = new LOTRAchievement(Category.GENERAL, 60, LOTRMod.scimitarOrc, "enchantBaneElf").setRequiresEnemy(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_ELF)).createTitle();
        enchantBaneOrc = new LOTRAchievement(Category.GENERAL, 61, LOTRMod.swordHighElven, "enchantBaneOrc").setRequiresEnemy(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_ORC)).createTitle();
        enchantBaneDwarf = new LOTRAchievement(Category.GENERAL, 62, LOTRMod.battleaxeGundabadUruk, "enchantBaneDwarf").setRequiresEnemy(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_DWARF)).createTitle();
        enchantBaneWarg = new LOTRAchievement(Category.GENERAL, 63, LOTRMod.swordRohan, "enchantBaneWarg").setRequiresEnemy(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_ORC)).createTitle();
        enchantBaneTroll = new LOTRAchievement(Category.GENERAL, 64, LOTRMod.swordArnor, "enchantBaneTroll").setRequiresEnemy(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_TROLL)).createTitle();
        enchantBaneSpider = new LOTRAchievement(Category.GENERAL, 65, LOTRMod.sting, "enchantBaneSpider").setRequiresEnemy(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_ORC)).createTitle();
        ...
        smeltBlueDwarfSteel = new LOTRAchievement(Category.BLUE_MOUNTAINS, 4, LOTRMod.dwarfSteel, "smeltBlueDwarfSteel");
        ...
        enterBreeland = new LOTRAchievement(Category.BREE_LAND, 0, Blocks.grass, "enterBreeland").setBiomeAchievement();
        ...
        killDunlending = new LOTRAchievement(Category.DUNLAND, 0, LOTRMod.dunlendingTrident, "killDunlending").setRequiresEnemy(LOTRFaction.DUNLAND).createTitle();
        ...
        enterMistyMountains = new LOTRAchievement(Category.MISTY_MOUNTAINS, 1, Blocks.stone, "enterMistyMountains").setBiomeAchievement();
        ...
        killDwarf = new LOTRAchievement(Category.IRON_HILLS, 0, LOTRMod.dwarfBone, "killDwarf").setRequiresEnemy(LOTRFaction.DWARF).createTitle();
        ...
        talkDwarfWoman = new LOTRAchievement(Category.IRON_HILLS, 10, LOTRMod.mugDwarvenAle, "talkDwarfWoman").setRequiresAlly(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_DWARF));
        ...
        marryDwarf = new LOTRAchievement(Category.IRON_HILLS, 16, LOTRMod.dwarvenRing, "marryDwarf").setRequiresAlly(LOTRFaction.getAllOfType(LOTRFaction.FactionType.TYPE_DWARF));
        ...
        tradeIronHillsMerchant = new LOTRAchievement(Category.IRON_HILLS, 18, LOTRMod.silverCoin, "tradeIronHillsMerchant").setRequiresAlly(LOTRFaction.DWARF);
        tradeDwarfSmith = new LOTRAchievement(Category.IRON_HILLS, 19, LOTRMod.silverCoin, "tradeDwarfSmith").setRequiresAlly(LOTRFaction.DWARF);
        killElf = new LOTRAchievement(Category.LOTHLORIEN, 0, LOTRMod.elfBone, "killElf").setRequiresEnemy(LOTRFaction.GALADHRIM).createTitle();
        ...
        tradeGaladhrimSmith = new LOTRAchievement(Category.LOTHLORIEN, 14, LOTRMod.silverCoin, "tradeGaladhrimSmith").setRequiresAlly(LOTRFaction.GALADHRIM);
        ...
        raidUrukCamp = new LOTRAchievement(Category.ROHAN, 0, Items.skull, "raidUrukCamp").setRequiresEnemy(LOTRFaction.URUK_HAI);
        ...
        hireWargBombardier = new LOTRAchievement(Category.ROHAN, 7, LOTRMod.fur, "hireWargBombardier").setRequiresAlly(LOTRFaction.URUK_HAI);
        ...
        doMiniquestIsengard = new LOTRAchievement(Category.ROHAN, 22, LOTRMod.redBook, "doMiniquestIsengard").setRequiresAlly(LOTRFaction.URUK_HAI);
        killUrukHai = new LOTRAchievement(Category.ROHAN, 23, LOTRMod.orcBone, "killUrukHai").setRequiresEnemy(LOTRFaction.URUK_HAI).createTitle();
        ...
        killIsengardSnaga = new LOTRAchievement(Category.ROHAN, 26, LOTRMod.orcBone, "killIsengardSnaga").setRequiresEnemy(LOTRFaction.URUK_HAI).createTitle();
        ...
        useRhunTable = new LOTRAchievement(Category.RHUN, 4, LOTRMod.rhunTable, "useRhunTable").setRequiresAlly(LOTRFaction.RHUN);
        killEasterling = new LOTRAchievement(Category.RHUN, 5, Items.bone, "killEasterling").setRequiresEnemy(LOTRFaction.RHUN).createTitle();
        doMiniquestRhun = new LOTRAchievement(Category.RHUN, 6, LOTRMod.redBook, "doMiniquestRhun").setRequiresAlly(LOTRFaction.RHUN);
        wearFullRhun = new LOTRAchievement(Category.RHUN, 7, LOTRMod.bodyRhun, "wearFullRhun");
        tradeRhunBlacksmith = new LOTRAchievement(Category.RHUN, 8, LOTRMod.silverCoin, "tradeRhunBlacksmith").setRequiresAlly(LOTRFaction.RHUN);
        tradeRhunCaptain = new LOTRAchievement(Category.RHUN, 9, LOTRMod.silverCoin, "tradeRhunCaptain").setRequiresAlly(LOTRFaction.RHUN);
        ...
        enterMountainsWind = new LOTRAchievement(Category.RHUN, 14, Blocks.stone, "enterMountainsWind").setBiomeAchievement();
        tradeRhunMarketTrader = new LOTRAchievement(Category.RHUN, 15, LOTRMod.silverCoin, "tradeRhunMarketTrader").setRequiresAlly(LOTRFaction.RHUN);
        tradeRhunBartender = new LOTRAchievement(Category.RHUN, 16, LOTRMod.silverCoin, "tradeRhunBartender").setRequiresAlly(LOTRFaction.RHUN);
        hireRhunFarmer = new LOTRAchievement(Category.RHUN, 17, LOTRMod.hoeBronze, "hireRhunFarmer").setRequiresAlly(LOTRFaction.RHUN);
        ...
        killMoredain = new LOTRAchievement(Category.FAR_HARAD_SAVANNAH, 7, Items.bone, "killMoredain").setRequiresEnemy(LOTRFaction.MOREDAIN).createTitle();
        useMoredainTable = new LOTRAchievement(Category.FAR_HARAD_SAVANNAH, 8, LOTRMod.moredainTable, "useMoredainTable").setRequiresAlly(LOTRFaction.MOREDAIN);
        wearFullMoredain = new LOTRAchievement(Category.FAR_HARAD_SAVANNAH, 9, LOTRMod.bodyMoredain, "wearFullMoredain");
        tradeMoredainChieftain = new LOTRAchievement(Category.FAR_HARAD_SAVANNAH, 10, LOTRMod.silverCoin, "tradeMoredainChieftain").setRequiresAlly(LOTRFaction.MOREDAIN);
        doMiniquestMoredain = new LOTRAchievement(Category.FAR_HARAD_SAVANNAH, 11, LOTRMod.redBook, "doMiniquestMoredain").setRequiresAlly(LOTRFaction.MOREDAIN);
        tradeMoredainVillager = new LOTRAchievement(Category.FAR_HARAD_SAVANNAH, 12, LOTRMod.silverCoin, "tradeMoredainVillager").setRequiresAlly(LOTRFaction.MOREDAIN);
        ...
        doMiniquestTauredain = new LOTRAchievement(Category.FAR_HARAD_JUNGLE, 5, LOTRMod.redBook, "doMiniquestTauredain").setRequiresAlly(LOTRFaction.TAUREDAIN);
        useTauredainTable = new LOTRAchievement(Category.FAR_HARAD_JUNGLE, 6, LOTRMod.tauredainTable, "useTauredainTable").setRequiresAlly(LOTRFaction.TAUREDAIN);
        wearFullTauredain = new LOTRAchievement(Category.FAR_HARAD_JUNGLE, 7, LOTRMod.bodyTauredain, "wearFullTauredain");
        killTauredain = new LOTRAchievement(Category.FAR_HARAD_JUNGLE, 8, Items.bone, "killTauredain").setRequiresEnemy(LOTRFaction.TAUREDAIN).createTitle();
        tradeTauredainChieftain = new LOTRAchievement(Category.FAR_HARAD_JUNGLE, 9, LOTRMod.silverCoin, "tradeTauredainChieftain").setRequiresAlly(LOTRFaction.TAUREDAIN);
        tradeTauredainShaman = new LOTRAchievement(Category.FAR_HARAD_JUNGLE, 10, LOTRMod.silverCoin, "tradeTauredainShaman").setRequiresAlly(LOTRFaction.TAUREDAIN);
        smeltObsidianShard = new LOTRAchievement(Category.FAR_HARAD_JUNGLE, 11, LOTRMod.obsidianShard, "smeltObsidianShard");
        tradeTauredainFarmer = new LOTRAchievement(Category.FAR_HARAD_JUNGLE, 12, LOTRMod.silverCoin, "tradeTauredainFarmer").setRequiresAlly(LOTRFaction.TAUREDAIN);
        hireTauredainFarmer = new LOTRAchievement(Category.FAR_HARAD_JUNGLE, 13, LOTRMod.hoeTauredain, "hireTauredainFarmer").setRequiresAlly(LOTRFaction.TAUREDAIN);
        tradeTauredainSmith = new LOTRAchievement(Category.FAR_HARAD_JUNGLE, 14, LOTRMod.silverCoin, "tradeTauredainSmith").setRequiresAlly(LOTRFaction.TAUREDAIN);
        enterPertorogwaith = new LOTRAchievement(Category.PERTOROGWAITH, 0, Blocks.stone, "enterPertorogwaith").setBiomeAchievement();
        killHalfTroll = new LOTRAchievement(Category.PERTOROGWAITH, 4, LOTRMod.trollBone, "killHalfTroll").setRequiresEnemy(LOTRFaction.HALF_TROLL).createTitle();
        wearFullHalfTroll = new LOTRAchievement(Category.PERTOROGWAITH, 5, LOTRMod.bodyHalfTroll, "wearFullHalfTroll");
        tradeHalfTrollWarlord = new LOTRAchievement(Category.PERTOROGWAITH, 6, LOTRMod.silverCoin, "tradeHalfTrollWarlord").setRequiresAlly(LOTRFaction.HALF_TROLL);
        useHalfTrollTable = new LOTRAchievement(Category.PERTOROGWAITH, 7, LOTRMod.halfTrollTable, "useHalfTrollTable").setRequiresAlly(LOTRFaction.HALF_TROLL);
        doMiniquestHalfTroll = new LOTRAchievement(Category.PERTOROGWAITH, 8, LOTRMod.redBook, "doMiniquestHalfTroll").setRequiresAlly(LOTRFaction.HALF_TROLL);
        tradeHalfTrollScavenger = new LOTRAchievement(Category.PERTOROGWAITH, 9, LOTRMod.silverCoin, "tradeHalfTrollScavenger").setRequiresAlly(LOTRFaction.HALF_TROLL);
        enterHalfTrollForest = new LOTRAchievement(Category.PERTOROGWAITH, 10, new ItemStack(LOTRMod.brick4, 1, 2), "enterHalfTrollForest").setBiomeAchievement();
        ...
        enterUtumnoIce = new LOTRAchievement(Category.SHADOW, 0, new ItemStack(LOTRMod.utumnoBrick, 1, 3), "enterUtumnoIce").setSpecial().createTitle("enterUtumno");
        enterUtumnoObsidian = new LOTRAchievement(Category.SHADOW, 1, new ItemStack(LOTRMod.utumnoBrick, 1, 5), "enterUtumnoObsidian").setSpecial();
        enterUtumnoFire = new LOTRAchievement(Category.SHADOW, 2, new ItemStack(LOTRMod.utumnoBrick, 1, 1), "enterUtumnoFire").setSpecial().createTitle("enterUtumnoFire");
        wearFullUtumno = new LOTRAchievement(Category.SHADOW, 3, LOTRMod.bodyUtumno, "wearFullUtumno");
        killUtumnoOrc = new LOTRAchievement(Category.SHADOW, 4, LOTRMod.orcBone, "killUtumnoOrc");
        killUtumnoWarg = new LOTRAchievement(Category.SHADOW, 5, LOTRMod.wargBone, "killUtumnoWarg");
        killBalrog = new LOTRAchievement(Category.SHADOW, 6, LOTRMod.balrogWhip, "killBalrog").createTitle();
        killTormentedElf = new LOTRAchievement(Category.SHADOW, 7, LOTRMod.elfBone, "killTormentedElf");
        killUtumnoTroll = new LOTRAchievement(Category.SHADOW, 8, LOTRMod.trollBone, "killUtumnoTroll");
        craftUtumnoKey = new LOTRAchievement(Category.SHADOW, 9, LOTRMod.utumnoKey, "craftUtumnoKey");
        leaveUtumno = new LOTRAchievement(Category.SHADOW, 10, LOTRMod.swordUtumno, "leaveUtumno").createTitle();
        
        killUruk_dg = new LOTRAchievement(Category.MIRKWOOD, 27, LOTRMod.orcBone, "killUruk_dg").setRequiresEnemy(LOTRFaction.DOL_GULDUR).createTitle();

        marryWindDwarf = new LOTRAchievement(Category.WIND_MOUNTAINS, 0, LOTRMod.dwarvenRing, "marryWindDwarf").setRequiresAlly(LOTRFaction.WIND_MOUNTAINS);
        killWindDwarf = new LOTRAchievement(Category.WIND_MOUNTAINS, 1, LOTRMod.dwarfBone, "killWindDwarf").setRequiresEnemy(LOTRFaction.WIND_MOUNTAINS).createTitle();
        tradeWindDwarfCommander = new LOTRAchievement(Category.WIND_MOUNTAINS, 2, LOTRMod.silverCoin, "tradeWindDwarfCommander").setRequiresAlly(LOTRFaction.WIND_MOUNTAINS);
        tradeWindDwarfMerchant = new LOTRAchievement(Category.WIND_MOUNTAINS, 3, LOTRMod.silverCoin, "tradeWindDwarfMerchant").setRequiresAlly(LOTRFaction.WIND_MOUNTAINS);
        tradeWindDwarfSmith = new LOTRAchievement(Category.WIND_MOUNTAINS, 4, LOTRMod.silverCoin, "tradeWindDwarfSmith").setRequiresAlly(LOTRFaction.WIND_MOUNTAINS);
        doMiniquestWindMountains = new LOTRAchievement(Category.WIND_MOUNTAINS, 5, LOTRMod.redBook, "doMiniquestWindMountains").setRequiresAlly(LOTRFaction.WIND_MOUNTAINS);

        marryRedDwarf = new LOTRAchievement(Category.RED_MOUNTAINS, 0, LOTRMod.dwarvenRing, "marryRedDwarf").setRequiresAlly(LOTRFaction.RED_MOUNTAINS);
        killRedDwarf = new LOTRAchievement(Category.RED_MOUNTAINS, 1, LOTRMod.dwarfBone, "killRedDwarf").setRequiresEnemy(LOTRFaction.RED_MOUNTAINS).createTitle();
        tradeRedDwarfCommander = new LOTRAchievement(Category.RED_MOUNTAINS, 2, LOTRMod.silverCoin, "tradeRedDwarfCommander").setRequiresAlly(LOTRFaction.RED_MOUNTAINS);        
        tradeRedDwarfMerchant = new LOTRAchievement(Category.RED_MOUNTAINS, 3, LOTRMod.silverCoin, "tradeRedDwarfMerchant").setRequiresAlly(LOTRFaction.RED_MOUNTAINS);
        tradeRedDwarfSmith = new LOTRAchievement(Category.RED_MOUNTAINS, 4, LOTRMod.silverCoin, "tradeRedDwarfSmith").setRequiresAlly(LOTRFaction.RED_MOUNTAINS);
        doMiniquestRedMountains = new LOTRAchievement(Category.RED_MOUNTAINS, 5, LOTRMod.redBook, "doMiniquestRedMountains").setRequiresAlly(LOTRFaction.RED_MOUNTAINS);
        
        tradeDarkWoodElfCaptain = new LOTRAchievement(Category.DARK_WOOD, 0, LOTRMod.silverCoin, "tradeDarkWoodCommander").setRequiresAlly(LOTRFaction.DARK_WOOD);
        tradeDarkWoodBlacksmith = new LOTRAchievement(Category.DARK_WOOD, 1, LOTRMod.silverCoin, "tradeDarkWoodBlacksmith").setRequiresAlly(LOTRFaction.DARK_WOOD);
        doMiniquestDarkWood = new LOTRAchievement(Category.DARK_WOOD, 2, LOTRMod.redBook, "doMiniquestDarkWood").setRequiresAlly(LOTRFaction.DARK_WOOD);

        killNumenor = new LOTRAchievement(Category.NUMENOR, 0, LOTRMod.swordNumenor, "killNumenor").setRequiresEnemy(LOTRFaction.NUMENOR).createTitle();        
        tradeNumenorCaptain = new LOTRAchievement(Category.NUMENOR, 1, LOTRMod.silverCoin, "tradeNumenorCommander").setRequiresAlly(LOTRFaction.NUMENOR);
        tradeNumenorBlacksmith = new LOTRAchievement(Category.NUMENOR, 2, LOTRMod.silverCoin, "tradeNumenorBlacksmith").setRequiresAlly(LOTRFaction.NUMENOR);
        doMiniquestNumenor = new LOTRAchievement(Category.NUMENOR, 3, LOTRMod.redBook, "doMiniquestNumenor").setRequiresAlly(LOTRFaction.NUMENOR);
        tradeNumenorBartender = new LOTRAchievement(Category.NUMENOR, 4, LOTRMod.silverCoin, "tradeNumenorBartender").setRequiresAlly(LOTRFaction.NUMENOR);
        buyPipeweedNumenorFarmer = new LOTRAchievement(Category.NUMENOR, 5, LOTRMod.pipeweedPlant, "buyPipeweedNumenorFarmer").setRequiresAlly(LOTRFaction.NUMENOR);
        hireNumenorFarmer = new LOTRAchievement(Category.NUMENOR, 6, Items.iron_hoe, "hireNumenorFarmer").setRequiresAlly(LOTRFaction.NUMENOR);
        tradeNumenorMarketTrader = new LOTRAchievement(Category.NUMENOR, 7, LOTRMod.silverCoin, "tradeNumenorMarketTrader").setRequiresAlly(LOTRFaction.NUMENOR);

        
        killKhanding = new LOTRAchievement(Category.KHAND, 0, Items.bone, "killKhanding").setRequiresEnemy(LOTRFaction.KHAND).createTitle();
        enterKhand = new LOTRAchievement(Category.KHAND, 1, Blocks.sand, "enterKhand").setBiomeAchievement();
        tradeKhandCaptain = new LOTRAchievement(Category.KHAND, 2, LOTRMod.silverCoin, "tradeKhandCommander").setRequiresAlly(LOTRFaction.KHAND);
        tradeKhandBlacksmith = new LOTRAchievement(Category.KHAND, 3, LOTRMod.silverCoin, "tradeKhandBlacksmith").setRequiresAlly(LOTRFaction.KHAND);
        doMiniquestKhand = new LOTRAchievement(Category.KHAND, 4, LOTRMod.redBook, "doMiniquestKhand").setRequiresAlly(LOTRFaction.KHAND);
    }
    ...
    public IChatComponent getAchievementChatComponent(EntityPlayer entityplayer) {
        ChatComponentTranslation component = new ChatComponentTranslation(this.getTitle(entityplayer), new Object[0]).createCopy();
    ...
    public void broadcastEarning(EntityPlayer entityplayer) {
        ...
        String dimName = this.getDimension().getDimensionName();
    ...
    public static enum Category {
        GENERAL(15916746),
        SHADOW(LOTRFaction.SHADOW),
        WIND_MOUNTAINS(LOTRFaction.WIND_MOUNTAINS),
        RED_MOUNTAINS(LOTRFaction.RED_MOUNTAINS),
        NUMENOR(LOTRFaction.NUMENOR),
        DARK_WOOD(LOTRFaction.DARK_WOOD),
        KHAND(LOTRFaction.KHAND),
        ...
        IRON_HILLS(LOTRFaction.DWARF),
        LOTHLORIEN(LOTRFaction.GALADHRIM),
        ...
        PERTOROGWAITH(LOTRBiome.pertorogwaith),

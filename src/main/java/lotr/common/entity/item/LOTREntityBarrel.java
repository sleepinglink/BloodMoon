...
public class LOTREntityBarrel extends Entity {
    ...
    public void onUpdate() {
        ...
        if(this.worldObj.isRemote && this.isBoatEmpty) {
            ...
            if(this.riddenByEntity != null && this.riddenByEntity instanceof EntityLivingBase && (d4 = ((EntityLivingBase) this.riddenByEntity).moveForward) > 0.0) {
        ...
        if(!this.worldObj.isRemote && this.riddenByEntity instanceof EntityPlayer && this.worldObj.isAABBInMaterial(this.boundingBox, Material.water) && this.worldObj.getBiomeGenForCoords(i = MathHelper.floor_double(this.posX), k = MathHelper.floor_double(this.posZ)) instanceof LOTRBiomeGenMirkwood) {

...
public class LOTRBrewingRecipes {
    ...
    public static void createBrewingRecipes() {
        ...
        LOTRBrewingRecipes.addBrewingRecipe(new ItemStack(LOTRMod.mugboyar, BARREL_CAPACITY), LOTRMod.boyarberry , LOTRMod.boyarberry , LOTRMod.boyarberry , LOTRMod.boyarberry , LOTRMod.boyarberry , LOTRMod.boyarberry);

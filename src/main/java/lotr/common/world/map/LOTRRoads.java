...
public class LOTRRoads {
    public static List<LOTRRoads> allRoads = new ArrayList<LOTRRoads>();
    ...
    public static void createRoads() {
        ...
        LOTRRoads.registerRoad("Chetroad", LOTRWaypoint.STADDLE, LOTRWaypoint.COMBE, LOTRWaypoint.ARCHET);
        ...
        LOTRRoads.registerRoad("Nobottom", LOTRWaypoint.TIGHFIELD, LOTRWaypoint.LITTLE_DELVING, LOTRWaypoint.NOBOTTLE, LOTRWaypoint.NEEDLEHOLE);
        ...
        LOTRRoads.registerRoad("GondorSouthRoad", LOTRWaypoint.MINAS_TIRITH, LOTRWaypoint.CROSSINGS_ERUI, LOTRWaypoint.PELARGIR);
        ...
        LOTRRoads.registerRoad("LebenninRoad", LOTRWaypoint.ERECH, LOTRWaypoint.TARLANG, LOTRWaypoint.CALEMBEL, LOTRWaypoint.ETHRING, LOTRWaypoint.LINHIR, LOTRWaypoint.PELARGIR, LOTRWaypoint.CROSSINGS_OF_POROS);
        LOTRRoads.registerRoad("DolAmroth", LOTRWaypoint.ETHRING, LOTRWaypoint.TARNOST, LOTRWaypoint.EDHELLOND, new int[] {1185, 1325}, LOTRWaypoint.DOL_AMROTH);
        ...
        LOTRRoads.registerRoad("GulfRoad", LOTRWaypoint.TOWN_BONES, new int[] {1794, 2110}, LOTRWaypoint.GULF_FORD, LOTRWaypoint.GULF_TRADE_TOWN, LOTRWaypoint.GULF_NORTH_TOWN, new int[] {1702, 1940}, LOTRWaypoint.GULF_OF_HARAD, new int[] {1775, 2002}, LOTRWaypoint.GULF_EAST_PORT);
        ...
        LOTRRoads.registerRoad("MorannonRhunRoad", LOTRWaypoint.MORANNON, new int[] {1520, 1130}, new int[] {1658, 1140}, new int[] {1780, 1115},
        LOTRWaypoint.MORDOR_FORD, LOTRWaypoint.RHUN_SOUTHEAST, LOTRWaypoint.KHAND_NORTH_ROAD, LOTRWaypoint.Beit_Guvrin, LOTRWaypoint.KHAND_FORD,
        LOTRWaypoint.HARNEN_BLACK_TOWN, LOTRWaypoint.CROSSINGS_OF_LITHNEN, LOTRWaypoint.HARNEN_ROAD_TOWN, LOTRWaypoint.HARNEN_RIVER_TOWN,
        LOTRWaypoint.HARNEN_SEA_TOWN, LOTRWaypoint.COAST_FORTRESS, LOTRWaypoint.GATE_FUINUR, LOTRWaypoint.UMBAR_CITY, LOTRWaypoint.GATE_HERUMOR);
        
        
        LOTRRoads.registerRoad("khandRoad", LOTRWaypoint.Beit_Guvrin, LOTRWaypoint.Sheim_ar_fling); 
        LOTRRoads.registerRoad("khand2Road", LOTRWaypoint.Beit_Guvrin,LOTRWaypoint.Sheim_o_pong); 
        ...
        private static LOTRRoads[] getSplines(String name, RoadPoint[] waypoints) {
            if(waypoints.length == 2) {
                ...
                for(int l = 0; l < points; ++l) {
                    ...
                    road.roadPoints[l] = point = BezierCurves.bezier(p1, p1, p2, p2, t);

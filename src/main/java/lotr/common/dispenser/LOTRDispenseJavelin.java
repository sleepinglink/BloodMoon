...
public class LOTRDispenseJavelin extends BehaviorDefaultDispenseItem {
    @Override
    public ItemStack dispenseStack(IBlockSource dispenser, ItemStack itemstack) {
        ...
        LOTREntityJavelin spear = new  LOTREntityJavelin(world, itemstack.copy(), iposition.getX(), iposition.getY(), iposition.getZ());

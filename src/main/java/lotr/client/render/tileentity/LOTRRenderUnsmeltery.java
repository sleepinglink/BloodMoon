...
public class LOTRRenderUnsmeltery extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity tileentity, double d, double d1, double d2, float f) {
        ...
        boolean bl = useActiveTexture = unsmeltery != null && LOTRBlockForgeBase.isForgeActive(unsmeltery.getWorldObj(), unsmeltery.xCoord, unsmeltery.yCoord, unsmeltery.zCoord);
        if(useActiveTexture) {

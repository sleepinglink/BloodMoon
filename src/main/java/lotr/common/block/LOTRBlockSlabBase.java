...
public abstract class LOTRBlockSlabBase extends BlockSlab {
    ...
    public boolean shouldSideBeRendered(IBlockAccess world, int i, int j, int k, int l) {
        ...
        boolean bl = flag = (world.getBlockMetadata(i1, j1, k1) & 8) != 0;
    ...
    public static class SlabItems {
        ...
        public static class Slab15Double extends ItemSlab {
            public Slab15Double(Block block) {
                super(block, (BlockSlab) LOTRMod.slabSingle15, (BlockSlab) LOTRMod.slabDouble15, true);
            }
        }
        
        public static class Slab15Single extends ItemSlab {
            public Slab15Single(Block block) {
                super(block, (BlockSlab) LOTRMod.slabSingle15, (BlockSlab) LOTRMod.slabDouble15, false);
            }
        }

...
public class LOTRWorldGenNumenorTavern extends LOTRWorldGenNumenorStructure {
    private String[] tavernName;
    private String[] tavernNameSign;
    private String tavernNameNPC;

    public LOTRWorldGenNumenorTavern(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for(int i15 = -7; i15 <= 11; ++i15) {
            for(k13 = 0; k13 <= 14; ++k13) {
                ...
                if(i15 == -7 || i15 == 11) {
                    ...
                    int n = beam = IntMath.mod(i15, 4) == 2 ? 1 : 0;
                }
                if(beam != 0) {
        ...
        for(int i16 = -8; i16 <= 12; ++i16) {
            for(k13 = -1; k13 <= 15; ++k13) {
                ...
                if(i16 == -8 || i16 == 12) {
                    ...
                    int n = beam = IntMath.mod(i16, 4) == 2 ? 1 : 0;
                }
                if(beam != 0) {
                    if(i16 == -8 || i16 == 12) {
        ...
        this.placeChest(world, random, -3, 0, 8, 5, LOTRChestContents2.NUMENOR_HOUSE);
        for(k14 = 6; k14 <= 8; ++k14) {
        ...
        LOTREntityNumenorBartender bartender = new LOTREntityNumenorBartender(world);
        ...
        for(int l = 0; l < men; ++l) {
            LOTREntityNumenor gondorian = new LOTREntityNumenor(world);

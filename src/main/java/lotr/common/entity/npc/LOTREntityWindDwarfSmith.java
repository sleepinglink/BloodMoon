...
public class LOTREntityWindDwarfSmith extends LOTREntityWindDwarf implements LOTRTradeable.Smith{
	
	public LOTREntityWindDwarfSmith(World world) {
        super(world);
    ...
    public void onPlayerTrade(EntityPlayer entityplayer, LOTRTradeEntries.TradeType type, ItemStack itemstack) {
        LOTRLevelData.getData(entityplayer).addAchievement(LOTRAchievement.tradeWindDwarfSmith);
    }

                ...
                for(j1 = j + height; j1 >= leafMin; --j1) {
                    ...
                    for(int b = 0; b < branches; ++b) {
                        ...
                        for(int l = 0; l < length; ++l) {
                            ...
                            if(!(block = world.getBlock(i1, j2, k1)).isReplaceable(world, i1, j2, k1) && !block.isWood(world, i1, j2, k1) && !block.isLeaves(world, i1, j2, k1)) break;
        ...
        for(int j1 = leafStart; j1 <= leafTop; ++j1) {
            ...
            for(int i1 = i - leafRange; i1 <= i + leafRange; ++i1) {
                for(int k1 = k - leafRange; k1 <= k + leafRange; ++k1) {
                    ...
                    if(!grow || !(block = world.getBlock(i1, j1, k1)).isReplaceable(world, i1, j1, k1) && !block.isLeaves(world, i1, j1, k1)) continue;

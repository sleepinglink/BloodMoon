...
public class LOTRItemSwordStory extends LOTRItemSword {
    @SideOnly(value = Side.CLIENT)
    public IIcon glowingIcon;
    private boolean isElvenBlade = false;
    protected float lotrWeaponDamage;

    public LOTRItemSwordStory(LOTRMaterial material) {
        this(material.toToolMaterial());
    }

    public LOTRItemSwordStory(Item.ToolMaterial material) {
        super(material);

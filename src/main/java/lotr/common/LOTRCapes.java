...
public class LOTRCapes {
    public static ResourceLocation DARK_WOOD = LOTRCapes.forName("darkwood");
    public static ResourceLocation NUMENOR = LOTRCapes.forName("numenor");
    public static ResourceLocation KHAND = LOTRCapes.forName("khand");

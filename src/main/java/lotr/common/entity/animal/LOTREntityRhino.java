            ...
            if(this.riddenByEntity instanceof EntityLivingBase) {
                ...
                if(momentum >= 0.32f) {
                    ...
                    for(Object element : list) {
                        ...
                        if(!(obj instanceof EntityLivingBase) || (entity = (EntityLivingBase) obj) == rhinoRider || rhinoRider instanceof EntityPlayer && !LOTRMod.canPlayerAttackEntity((EntityPlayer) rhinoRider, entity, false) || rhinoRider instanceof EntityCreature && !LOTRMod.canNPCAttackEntity((EntityCreature) rhinoRider, entity, false) || !(flag = entity.attackEntityFrom(DamageSource.causeMobDamage(this), strength))) continue;

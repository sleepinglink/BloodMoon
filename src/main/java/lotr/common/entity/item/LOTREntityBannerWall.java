...
public class LOTREntityBannerWall extends EntityHanging {
    ...
    public boolean attackEntityFrom(DamageSource damagesource, float f) {
        ...
        if(!this.worldObj.isRemote && damagesource.getEntity() instanceof EntityPlayer && LOTRBannerProtection.isProtectedByBanner(this.worldObj, this, LOTRBannerProtection.forPlayer(entityplayer = (EntityPlayer) damagesource.getEntity()), true)) {
            return false;
        }

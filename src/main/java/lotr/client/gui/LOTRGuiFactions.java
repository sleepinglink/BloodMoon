...
public class LOTRGuiFactions extends LOTRGuiMenuBase {
    ...
    public void initGui() {
        ...
        this.buttonPledgeConfirm = new LOTRGuiButtonPledge(this, 5, this.guiLeft + this.pageWidth / 2 - 16, this.guiTop + this.pageY + this.pageHeight - 50, "");
        this.buttonList.add(this.buttonPledgeConfirm);
        this.buttonPledgeRevoke = new LOTRGuiButtonPledge(this, 6, this.guiLeft + this.pageWidth / 2 - 16, this.guiTop + this.pageY + this.pageHeight - 50, "");
        this.buttonList.add(this.buttonPledgeRevoke);
        this.buttonPledgeRevoke.isBroken = true;
        prevDimension = currentDimension = LOTRDimension.getCurrentDimension(this.mc.theWorld);
    ...
    private void updateCurrentDimensionAndFaction() {
        ...
        currentDimension = LOTRDimension.getCurrentDimension(this.mc.theWorld);
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        if(!this.isPledging && !this.isUnpledging) {
            ...
            this.buttonFactionMap.enabled = currentPage != Page.RANKS && this.currentFaction.isPlayableAlignmentFaction() && LOTRDimension.getCurrentDimension(this.mc.theWorld) == this.currentFaction.factionDimension;
        ...
        if(this.currentFaction != null) {
            float alignment = this.isOtherPlayer && this.playerAlignmentMap != null ? this.playerAlignmentMap.get(this.currentFaction).floatValue() : clientPD.getAlignment(this.currentFaction);
            ...
            if(!this.isPledging && !this.isUnpledging) {
                ...
                if(this.isPledging) {
                    ...
                    if(facsPreventingPledge.isEmpty()) {
                        if(clientPD.canMakeNewPledge()) {
                            if(clientPD.canPledgeTo(this.currentFaction)) {
                                ...
                                displayLines.add("");
                                desc2 = StatCollector.translateToLocalFormatted("lotr.gui.factions.pledgeDesc2", new Object[0]);
                                displayLines.addAll(this.fontRendererObj.listFormattedStringToWidth(desc2, stringWidth2));
                            }
                        }
                        else {
                        ...
                        Collections.sort(facsPreventingPledge, new Comparator<LOTRFaction>() {
                            ...
                            public int compare(LOTRFaction o1, LOTRFaction o2) {
                                ...
                                return -Float.valueOf(align1).compareTo(Float.valueOf(align2));
                            }
                        });
                    ...
                    displayLines.add("");
                    desc5 = StatCollector.translateToLocalFormatted("lotr.gui.factions.unpledgeDesc2", new Object[0]);
                    displayLines.addAll(this.fontRendererObj.listFormattedStringToWidth(desc5, stringWidth2));
                }

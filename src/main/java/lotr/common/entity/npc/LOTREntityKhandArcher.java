...
public class LOTREntityKhandArcher extends LOTREntityKhandSoldier{
	 public LOTREntityKhandArcher(World world) {
	        super(world);
	    ...
	    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
	        ...
	        this.npcItemsInv.setRangedWeapon(new ItemStack(LOTRMod.khandBow));

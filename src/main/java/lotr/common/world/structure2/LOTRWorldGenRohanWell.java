...
public class LOTRWorldGenRohanWell extends LOTRWorldGenRohanStructure {
    public LOTRWorldGenRohanWell(boolean flag) {
        super(flag);
    }
        ...
        for(i1 = -2; i1 <= 2; ++i1) {
            for(k1 = -2; k1 <= 2; ++k1) {
                ...
                if(i2 == 0 && k2 == 1 || k2 == 0 && i2 == 1) {
                    this.setBlockAndMetadata(world, i1, 4, k1, this.plank2SlabBlock, this.plank2SlabMeta | 8);
                }
                if(i2 != 0 || k2 != 0) continue;
                this.setBlockAndMetadata(world, i1, 5, k1, this.plank2SlabBlock, this.plank2SlabMeta);
                for(j1 = 3; j1 <= 4; ++j1) {
                    this.setBlockAndMetadata(world, i1, j1, k1, this.fenceBlock, this.fenceMeta);
                }
            }

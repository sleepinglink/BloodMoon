...
import lotr.common.entity.npc.LOTREntityNumenorCommander;
import lotr.common.world.structure.LOTRChestContents;
import lotr.common.world.structure.LOTRChestContents2;
import net.minecraft.init.Blocks;
import net.minecraft.world.World;

public class LOTRWorldGenNumenorFortress extends LOTRWorldGenNumenorStructure {
    public LOTRWorldGenNumenorFortress(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for(int i15 : new int[] {-10, 10}) {
            ...
            this.placeChest(world, random, i15, 1, -6, LOTRMod.chestLebethron, 2, LOTRChestContents2.NUMENOR_FORTRESS_SUPPLIES, 1);
            this.setAir(world, i15, 2, -6);
            this.spawnItemFrame(world, i15, 3, -6, 2, this.getGondorFramedItem(random));
            this.placeChest(world, random, i15, 1, 6, LOTRMod.chestLebethron, 3, LOTRChestContents2.NUMENOR_FORTRESS_SUPPLIES, 1);
            this.setAir(world, i15, 2, 6);
        ...
        for(i2 = 0; i2 < k12; ++i2) {
            ...
            this.placeChest(world, random, -6, 1, k152, LOTRMod.chestLebethron, 5, LOTRChestContents2.NUMENOR_FORTRESS_SUPPLIES, 1);
            this.setAir(world, -6, 2, k152);
            this.spawnItemFrame(world, -6, 3, k152, 3, this.getGondorFramedItem(random));
            this.placeChest(world, random, 6, 1, k152, LOTRMod.chestLebethron, 4, LOTRChestContents2.NUMENOR_FORTRESS_SUPPLIES, 1);
            this.setAir(world, 6, 2, k152);
        ...
        this.placeChest(world, random, 8, 1, 2, LOTRMod.chestLebethron, 5, LOTRChestContents2.NUMENOR_FORTRESS_SUPPLIES);
        ...
        for(i1 = -4; i1 <= 4; ++i1) {
            ...
            this.placeChest(world, random, i1, 1, 8, LOTRMod.chestLebethron, 2, LOTRChestContents2.NUMENOR_FORTRESS_DRINKS);
        }
        ...
        LOTREntityNumenorCommander captain = (LOTREntityNumenorCommander) this.strFief.createCaptain(world);
        ...
        for(int l = 0; l < soldiers; ++l) {
            ...
            LOTREntityNumenor soldier = (LOTREntityNumenor) LOTREntities.createEntityByClass(entityClass, world);

...
public class LOTREntityNumenorArcher extends LOTREntityNumenorSoldier{
	 public LOTREntityNumenorArcher(World world) {
	        super(world);
	    ...
	    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
	        ...
	        this.npcItemsInv.setRangedWeapon(new ItemStack(LOTRMod.numenorBow));
